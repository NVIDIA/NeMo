...
; WANDB_EXP_NAME="all-2020-2022-8b_fou-lora_lr1e-5_epoch3--sft--qna_2020-2022_qui_coc_sampl-1.0-1.0_lr5e-6_epoch3" \
...
; python examples/nlp/language_modeling/tuning/megatron_gpt_peft_tuning.py \
   ...
   model.data.train_ds.concat_sampling_probabilities=[1.0,1.0] \
   model.data.validation_ds.file_names=["${DATA_DIR_QNA}/sec_qna_2020-2022_train_num-200-shuffle_val_input-outupt_quiet_cockatoo_validation.jsonl"] \
...
# 1 epoch ~= 250 = 89316246 / (2048 * 6 * (8/4)*8 * (192/(6*(8/4)*8)))
