...
; WANDB_EXP_NAME="all-2020-2022-8b_fou-lora_lr1e-5_epoch3--sft-lora--qna_2020-2022-x12_qui_coc_sampl-0.5-0.5_lr5e-6_epoch9" \
...
; python examples/nlp/language_modeling/tuning/megatron_gpt_peft_tuning.py \
   ...
   model.data.train_ds.file_names=["${DATA_DIR_QUIET_COCKATOO}/quiet-cockatoo_train.jsonl","${DATA_DIR_QNA}/sec_qna_2020-2022_train_num-200-shuffle_train_input-outupt_aug12x.jsonl"] \
   model.data.train_ds.max_seq_length=2048 \
   model.data.train_ds.concat_sampling_probabilities=[0.5,0.5] \
...
# 1 epoch ~= 250 = 89350501 / (2048 * 6 * (8/4)*8 * (192/(6*(8/4)*8)))
#	 model.peft.restore_from_path=/home/hshin/results/sec_continue_pretrain/all-2020-2022-8b_fou-lora_lr1e-5_epoch3/checkpoints/all-2020-2022-8b_fou-lora_lr1e-5_epoch3.nemo \
