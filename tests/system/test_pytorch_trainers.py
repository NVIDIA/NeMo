...
class TestPytorchTrainers(TestCase):
    ...
    def test_simple_train(self):
        """ Simplest train test """
        data_source = nemo.backends.pytorch.tutorials.RealFunctionDataLayer(n=1000, batch_size=128)
    ...
    def test_simple_chained_train(self):
        """ Chained train test """
        data_source = nemo.backends.pytorch.tutorials.RealFunctionDataLayer(n=1000, batch_size=32)
