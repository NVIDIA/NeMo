...
class TestNemoTransfer:
    ...
    def _prep_test_data(self):
        ...
        self.test_data["GPT-843M-base"]["checkpoint"] = (
        ...
        self.test_data["GPT-2B-HF-base"]["checkpoint"] = self.test_data["GPT-2B-HF-base"][
                                                             "checkpoint_dir"] + "GPT-2B-001_bf16_tp1.nemo"
        ...
        self.test_data["GPT-2B-base"]["checkpoint"] = (
            "/opt/checkpoints/GPT-2B-base/megatron_converted_2b_tp1_pp1.nemo")
        ...
        self.test_data["GPT-8B-base"]["checkpoint"] = (
            "/opt/checkpoints/GPT-8B-base/megatron_converted_8b_tp4_pp1.nemo")
        ...
        self.test_data["GPT-43B-base"]["checkpoint"] = (
