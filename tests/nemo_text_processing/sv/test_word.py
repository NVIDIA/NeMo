...
class TestWord:
    ...
    @pytest.mark.unit
    def test_denorm_sv(self, test_input, expected):
    ...
    def test_norm(self, test_input, expected):
        ...
        if self.normalizer_with_audio_sv:
            pred_non_deterministic = self.normalizer_with_audio_sv.normalize(
