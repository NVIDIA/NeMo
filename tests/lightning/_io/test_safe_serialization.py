...
from nemo.lightning.io.deserialize import DeserializationError, SafeDeserialization, SafePyrefPolicy
...
class TestSafeDeserialization:
    ...
    def test_basic_deserialization(self):
        ...
        safe_data = {
            "root": {"type": "leaf", "value": {"key": "value", "number": 42, "boolean": True}},
            "objects": {},
            "refcounts": {},
            "version": "0.0.1",
        }
    ...
    def test_blocked_imports(self):
        ...
        dangerous_data = {
            "root": {"type": {"type": "pyref", "module": "os", "name": "system"}, "items": [], "metadata": None},
            "objects": {},
            "refcounts": {},
            "version": "0.0.1",
        }
    ...
    def test_resource_limits(self):
        ...
        large_data = {
            "root": {"type": "leaf", "value": "x" * 1_000_000},
            "objects": {},
            "refcounts": {},
            "version": "0.0.1",
        }
        ...
        with pytest.raises(DeserializationError) as exc_info:
            SafeDeserialization(large_data, max_string_length=100_000).result
...
class TestSecurityFeatures:
    ...
    def test_nested_dangerous_objects(self):
        ...
        dangerous_cases = [
            # Lambda in list
            {
                "root": {"type": "leaf", "value": {"safe_key": [1, 2, {"unsafe": lambda x: x}]}},
                "objects": {},
                "refcounts": {},
                "version": "0.0.1",
            },
            # Function in dict
            {
                "root": {"type": "leaf", "value": {"unsafe": (lambda: None)}},
                "objects": {},
                "refcounts": {},
                "version": "0.0.1",
            },
            ...
            {
                "root": {"type": "leaf", "value": [{"nested": {"deep": {"unsafe": str.strip}}}]},
                "objects": {},
                "refcounts": {},
                "version": "0.0.1",
            },
    ...
    def test_type_confusion(self):
        ...
        confusing_data = {
            "root": {"type": "leaf", "value": type("DynamicType", (), {"__call__": lambda self: None})},
            "objects": {},
            "refcounts": {},
            "version": "0.0.1",
        }
    ...
    def test_non_string_dict_keys(self):
        ...
        invalid_data = {
            "root": {"type": "leaf", "value": {1: "value"}},  # numeric key
            "objects": {},
            "refcounts": {},
            "version": "0.0.1",
        }
...
class TestErrorHandling:
    ...
    def test_deserialization_error(self):
        ...
        invalid_data = {
            "root": {"type": "invalid_type", "items": [], "metadata": None},
            "objects": {},
            "refcounts": {},
            "version": "0.0.1",
        }
...
class TestThreadSafety:
    ...
    def test_concurrent_deserialization(self):
        ...
        safe_data = {"root": {"type": "leaf", "value": 42}, "objects": {}, "refcounts": {}, "version": "0.0.1"}
...
class TestPathSerialization:
    ...
    def test_path_platform_specific(self):
        ...
        path_data = {
            "root": {"type": "leaf", "value": Path("/some/path")},  # Changed to leaf type  # Direct Path object
            "objects": {},
            "refcounts": {},
            "version": "0.0.1",
        }
