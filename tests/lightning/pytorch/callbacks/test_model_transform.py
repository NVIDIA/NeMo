...
from nemo.lightning.pytorch.callbacks.model_transform import ModelTransform, MODEL_TRANSFORM, _call_counter
...
class TestModelTransformCallback:
    ...
    def test_setup_stores_transform(self, callback, pl_module, trainer, caplog):
        ...
        assert hasattr(callback.model_transform, '__num_calls__'), "callback.model_transform should have __num_calls__ attribute"
