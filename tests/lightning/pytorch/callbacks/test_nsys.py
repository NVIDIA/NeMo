...
class TestNsysCallback:
    ...
    def test_on_train_batch_start_profiling(self, mock_emit_nvtx, mock_cudart, mock_get_rank, 
                                            mock_trainer, mock_pl_module):
    ...
    @patch('nemo.lightning.pytorch.callbacks.nsys.get_rank')
    @patch('torch.cuda.cudart')
    def test_on_train_batch_start_no_profiling(self, mock_cudart, mock_get_rank, 
                                               mock_trainer, mock_pl_module):
    ...
    @patch('torch.cuda.cudart')
    @patch('torch.autograd.profiler.emit_nvtx')
    def test_on_train_batch_end_profiling(self, mock_emit_nvtx, mock_cudart, mock_get_rank, 
                                          mock_trainer, mock_pl_module):
    ...
    @patch('torch.cuda.cudart')
    @patch('torch.autograd.profiler.emit_nvtx')
    def test_on_train_batch_end_no_profiling(self, mock_emit_nvtx, mock_cudart, mock_get_rank, 
                                             mock_trainer, mock_pl_module):
    ...
    @pytest.mark.parametrize("start_step,end_step,batch_idx,expected_call", [
        (10, 20, 9, False),
        (10, 20, 10, True),
        (10, 20, 15, False),
        (10, 20, 20, False),
    ...
    @patch('torch.cuda.cudart')
    @patch('torch.autograd.profiler.emit_nvtx')
    def test_profiling_range(self, mock_emit_nvtx, mock_cudart, mock_get_rank, 
    ...
    @patch('nemo.lightning.pytorch.callbacks.nsys.get_rank')
    @patch('torch.cuda.cudart')
    def test_single_profile_range(self, mock_cudart, mock_get_rank, 
                                  mock_trainer, mock_pl_module):
