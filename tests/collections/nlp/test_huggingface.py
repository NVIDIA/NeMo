...
class TestHuggingFace(TestCase):
    ...
    def test_get_pretrained_bert_model(self):
        model = nemo_nlp.modules.get_lm_model(model_type='bert', pretrained_model_name='bert-base-uncased')
    ...
    def test_get_pretrained_distilbert_model(self):
        model = nemo_nlp.modules.get_lm_model(model_type='distilbert', pretrained_model_name='distilbert-base-uncased')
    ...
    def test_get_pretrained_roberta_model(self):
        model = nemo_nlp.modules.get_lm_model(model_type='roberta', pretrained_model_name='roberta-base')
    ...
    def test_get_pretrained_albert_model(self):
        model = nemo_nlp.modules.get_lm_model(model_type='albert', pretrained_model_name='albert-base-v1')
