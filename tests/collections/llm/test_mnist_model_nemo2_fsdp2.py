...
class LitAutoEncoder(pl.LightningModule, io.IOMixin, io.ConnectorMixin):
    ...
    def __init__(self, config):
        ...
        self.optim = MegatronOptimizerModule(
            config=OptimizerConfig(lr=1e-4, optimizer="adam", use_distributed_optimizer=False),
        )
...
def test_train_mnist_litautoencoder_with_megatron_fsdp2_strategy_single_gpu():
...
def run_train_mnist_litautoencoder_with_megatron_fsdp2_strategy_single_gpu():
...
if __name__ == "__main__":
    ...
    run_train_mnist_litautoencoder_with_megatron_fsdp2_strategy_single_gpu()
