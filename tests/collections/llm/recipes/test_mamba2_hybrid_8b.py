...
from nemo.collections.llm.recipes import mamba2_hybrid_8b
from nemo.collections.nlp.modules.common.tokenizer_utils import get_nmt_tokenizer
from nemo.lightning import Trainer


class TestMamba2Hybrid_8B:
    @pytest.fixture(scope="class")
    def recipe_module(self):
        return mamba2_hybrid_8b
    ...
    def test_tokenizer(self, recipe_module):
        ...
        assert tokenizer_config.library == 'megatron'  # Different from smaller models
        assert tokenizer_config.model_name == "GPTSentencePieceTokenizer"  # Different from smaller models
    ...
    def test_model(self, recipe_module):
        ...
        assert model_config.config.__fn_or_cls__ == llm.NVIDIAMambaHybridConfig8B  # Different config class
    ...
    def test_trainer(self, recipe_module):
        ...
        assert trainer_config.strategy.tensor_model_parallel_size == 8  # Different from smaller models
    ...
    def test_pretrain_recipe(self, recipe_module):
        ...
        # Check tensor parallelism in pretrain
    ...
    def test_finetune_recipe_without_peft(self, recipe_module):
        ...
        assert recipe.trainer.strategy.tensor_model_parallel_size == 8  # Different from smaller models
