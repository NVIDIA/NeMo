...
from nemo.collections.llm.recipes import nemotron5_hybrid_8b
from nemo.lightning import Trainer


class TestNemotron5Hybrid8B:
    @pytest.fixture(scope="class")
    def recipe_module(self):
        return nemotron5_hybrid_8b
    ...
    def test_model(self, recipe_module):
        ...
        assert model_config.config.__fn_or_cls__.__name__ == "Nemotron5HybridConfig8B"
