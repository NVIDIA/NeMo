...
from nemo.collections.llm.recipes import gemma_7b
...
class TestGemma7B:
    ...
    def test_model(self, recipe_module):
        ...
        assert model_config.__fn_or_cls__ == GemmaModel
        assert isinstance(model_config.config, run.Config)
        assert model_config.config.__fn_or_cls__ == GemmaConfig7B
    ...
    def test_trainer(self, recipe_module):
        ...
        assert trainer_config.strategy.tensor_model_parallel_size == 2  # Different from 2B
    ...
    def test_pretrain_recipe(self, recipe_module):
        ...
        assert recipe.model.__fn_or_cls__ == GemmaModel
