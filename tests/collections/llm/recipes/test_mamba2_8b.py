...
class TestMamba2_8B:
    ...
    def test_tokenizer(self, recipe_module):
        ...
        assert tokenizer_config.library == 'megatron'  # Different from other Mamba models
        assert tokenizer_config.model_name == "GPTSentencePieceTokenizer"  # Different from other Mamba models
    ...
    def test_model(self, recipe_module):
        ...
        assert model_config.config.__fn_or_cls__ == llm.NVIDIAMambaConfig8B  # Different config class
    ...
    def test_trainer(self, recipe_module):
        ...
        assert trainer_config.strategy.tensor_model_parallel_size == 8  # Different from other Mamba models
    ...
    def test_finetune_recipe_without_peft(self, recipe_module):
        ...
        assert recipe.trainer.strategy.tensor_model_parallel_size == 8  # Different from other Mamba models
