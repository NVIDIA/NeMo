...
"""
python /lustre/fsw/coreai_dlalgo_genai/ataghibakhsh/NeMo/tests/collections/llm/gpt/model/nm5_pretraining.py \
                        --devices=8 \
                        --max-steps=20 \
                        ...
                        --tokenizer-path=/lustre/fsw/coreai_dlalgo_genai/ataghibakhsh/checkpoints/nemotron5/multiMixV8.gpt4o_nc_sd.500000.128k.vocab.json
...
if __name__ == '__main__':
    ...
    # )
    ssm_config = llm.Nemotron5HybridConfig8B()

    model = llm.GPTModel(ssm_config, tokenizer=tokenizer)
