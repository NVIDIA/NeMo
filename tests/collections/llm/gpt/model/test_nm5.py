...
def main():
    ...
    tokenizer = get_nmt_tokenizer(
        ...
        vocab_file="/lustre/fsw/portfolios/coreai/users/ataghibakhsh/nm5_56b_final/multiMixV8.gpt4o_nc_sd.500000.128k.vocab.json",
        use_fast=True,
    )
...
if __name__ == "__main__":
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc-per-node=8 \
        /opt/NeMo/tests/collections/llm/gpt/model/test_nm5.py \
            --num-nodes=1 \
            --devices=8 \
            --max-steps=500000 \
            --val-check-interval=1000 \
            --experiment-dir=/lustre/fsw/portfolios/coreai/users/ataghibakhsh/logs/nm5_ux_logs \
            --mock-data \
            --seq-length=8192 \
