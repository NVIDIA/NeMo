...
class TestBaseConfigs:
    ...
    def test_mixtral_base_config(self):
        ...
        model_7b = model_cls(size=7)
        assert (
            model_7b.get_model_config().__name__ == "MixtralConfig8x7B"
    ...
    def test_mistral_base_config(self):
        ...
        model_7b = model_cls(size=7)
        assert (
            model_7b.get_model_config().__name__ == "MistralConfig7B"
