...
class TestUtils:
    def test_calculate_model_size(self):
        ...
        assert (
            model_size == 0.28
        ), f"expected model_size is 0.28 but got {model_size}."
        ...
        assert (
            model_size == 1.38
        ), f"expected model_size is 1.38 but got {model_size}."
        ...
        assert (
            model_size == 12.9
        ), f"expected model_size is 12.9 but got {model_size}."
    ...
    def test_calculate_train_time(self):
        ...
        assert (
            train_time == 4.13
        ), f"expected train_time is 4.13 but got {train_time}."
    ...
    def test_calculate_model_params(self):
        ...
        assert (
            params == (48, 8192, 64, None, None, 8e-05)
        ...
        assert (
            params == (56, 10240, 80, None, None, 7e-05)
        ...
        assert (
            params == (36, 8192, 64, None, None, 8e-05)
        ...
        assert (
            params == (16, 1536, 16, None, None, 0.00025)
