...
from nemo.collections.llm.tron.utils.instantiate_utils import (
...
from tests.collections.llm.tron.utils.instantiate import (
    AClass,
    Adam,
    AdamConf,
    AnotherClass,
...
@mark.parametrize(
    ...
    [
        param(
            {
                "_target_": "tests.collections.llm.tron.utils.instantiate.AClass",
                "a": 10,
                "b": 20,
                "c": 30,
                "d": 40,
        ...
        param(
            [
                ...
                {
                    "_target_": "tests.collections.llm.tron.utils.instantiate.BClass",
                    "a": 50,
                    "b": 60,
                    "c": 70,
                },
        ...
        param(
            {"_target_": "tests.collections.llm.tron.utils.instantiate.AClass", "b": 20, "c": 30},
            {"a": 10, "d": 40},
            AClass(10, 20, 30, 40),
            id="class+override",
        ),
        ...
        param(
            {"_target_": "tests.collections.llm.tron.utils.instantiate.AClass", "b": 200, "c": "${b}"},
            {"a": 10, "b": 99, "d": 40},
            AClass(10, 99, 99, 40),
        ...
        param(
            {
                "_target_": "tests.collections.llm.tron.utils.instantiate.ASubclass.class_method",
                "_partial_": True,
            },
            {},
        ...
        param(
            {
                "_target_": "tests.collections.llm.tron.utils.instantiate.AClass.static_method",
                "_partial_": True,
            },
            {},
        ...
        param(
            {"_target_": "tests.collections.llm.tron.utils.instantiate.AClass.static_method", "z": 43},
            {},
            43,
            id="static_method",
        ),
        ...
        param(
            {"_target_": "tests.collections.llm.tron.utils.instantiate.NestingClass"},
            {},
        ...
        param(
            {
                "_target_": "tests.collections.llm.tron.utils.instantiate.nesting.a.class_method",
                "_partial_": True,
            },
            {},
            partial(ASubclass.class_method),
        ...
        param(
            {
                "_target_": "tests.collections.llm.tron.utils.instantiate.nesting.a.static_method",
                "_partial_": True,
            },
            {},
        ...
        param(
            {
                "_target_": "tests.collections.llm.tron.utils.instantiate.module_function",
                "_partial_": True,
            },
            {},
        ...
        param(
            {"_target_": "tests.collections.llm.tron.utils.instantiate.module_function", "x": 43},
            {},
            43,
            id="call_function_in_module",
        ),
        ...
        param(
            {"_target_": "tests.collections.llm.tron.utils.instantiate.AClass", "_partial_": True},
        ...
        param(
            KeywordsInParamsClass,
            {
                "_target_": "tests.collections.llm.tron.utils.instantiate.KeywordsInParamsClass",
                "target": "foo",
                "partial": "bar",
            },
...
def test_none_cases() -> Any:
    ...
    cfg = {
        "_target_": "tests.collections.llm.tron.utils.instantiate.ArgsClass",
...
@mark.parametrize(
    ...
    [
        ...
        param(
            {
                "A": {
                    "_target_": "tests.collections.llm.tron.utils.instantiate.add_values",
                    "a": 1,
                    "b": 2,
                },
                "node": {
            ...
            DictConfig(
                {
                    "username": "test_user",
                    "node": {
                        "_target_": "tests.collections.llm.tron.utils.instantiate.TargetWithInstantiateInInit",
                        "user_config": {
                            "name": "${foo_b.username}",
                            "age": 40,
                        },
...
def test_class_instantiate_omegaconf_node(config: Any) -> Any:
    obj = instantiate(
        config,
        a=10,
        d={"_target_": "tests.collections.llm.tron.utils.instantiate.AnotherClass", "x": 99},
    )
...
@mark.parametrize("src", [{"_target_": "tests.collections.llm.tron.utils.instantiate.Adam"}])
def test_instantiate_adam(config: Any) -> None:
    with raises(
        InstantiationException,
        match=r"Error in call to target 'tests\.collections\.llm\.tron\.utils\.instantiate\.Adam':\nTypeError\(.*\)",
    ):
...
def test_instantiate_with_missing_module() -> None:
    _target_ = "tests.collections.llm.tron.utils.instantiate.ClassWithMissingModule"
    with raises(
        InstantiationException,
        match=dedent(
            rf"""
...
def test_instantiate_target_raising_exception_taking_no_arguments() -> None:
    _target_ = "tests.collections.llm.tron.utils.instantiate.raise_exception_taking_no_argument"
    with raises(
        InstantiationException,
        match=(
            dedent(
...
def test_toplevel_list_partial_not_allowed() -> None:
    config = [{"_target_": "tests.collections.llm.tron.utils.instantiate.ClassA", "a": 10, "b": 20, "c": 30}]
    with raises(
        InstantiationException,
...
@mark.parametrize(
    ...
    [
        ...
        param(
            {
                "_target_": "tests.collections.llm.tron.utils.instantiate.Tree",
                "value": 1,
                "left": {
                    "_target_": "tests.collections.llm.tron.utils.instantiate.Tree",
                    "value": 21,
        ...
        param(
            ...
            {
                "value": 1,
                "left": {"_target_": "tests.collections.llm.tron.utils.instantiate.Tree", "value": 2},
            },
        ...
        param(
            {"_target_": "tests.collections.llm.tron.utils.instantiate.Tree"},
            {
                "value": 1,
                "left": {"_target_": "tests.collections.llm.tron.utils.instantiate.Tree", "value": 2},
                "right": {"_target_": "tests.collections.llm.tron.utils.instantiate.Tree", "value": 3},
            },
        ...
        param(
            {
                "_target_": "tests.collections.llm.tron.utils.instantiate.Compose",
                "transforms": [
                    {
                        "_target_": "tests.collections.llm.tron.utils.instantiate.CenterCrop",
                        "size": 10,
                    },
                    {
                        "_target_": "tests.collections.llm.tron.utils.instantiate.Rotation",
                        "degrees": 45,
                    },
                ],
            },
        ...
        param(
            {
                "_target_": "tests.collections.llm.tron.utils.instantiate.Mapping",
                "dictionary": {
                    "a": MappingConf(),
                    "b": MappingConf(),
                },
...
@mark.parametrize(
    ...
    [
        ...
        param(
            {"_target_": "tests.collections.llm.tron.utils.instantiate.Tree", "_partial_": True},
            {"value": 1},
...
@mark.parametrize(
    ...
    [
        ...
        param(
            {"_target_": "tests.collections.llm.tron.utils.instantiate.AClass", "a": 10, "b": 20},
            {"_target_": "tests.collections.llm.tron.utils.instantiate.BClass"},
            BClass(10, 20, "c", "d"),
...
def test_locate_general_exception():
    ...
    try:
        ...
        with raises(
            ImportError,
            match="Error loading 'tests.collections.llm.tron.utils.instantiate.test_error_module'",
        ):
            _locate("tests.collections.llm.tron.utils.instantiate.test_error_module")
    finally:
...
def test_instantiate_node_error_with_call_false_and_extra_keys():
    ...
    config = DictConfig(
        {
            "_target_": "tests.collections.llm.tron.utils.instantiate.test_instantiate.SimpleCoverageClass",
            "_call_": False,
