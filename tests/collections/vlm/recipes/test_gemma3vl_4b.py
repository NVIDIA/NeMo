...
from nemo.collections.vlm import Gemma3VLConfig4B, Gemma3VLModel, LoRA
from nemo.collections.vlm.recipes import gemma3vl_4b
from nemo.lightning import Trainer


class TestGemma3VL4B:
    ...
    def test_model(self, recipe_module):
        ...
        # Verify the inner configuration is a run.Config for Gemma3VLConfig4B
        assert isinstance(model_config.config, run.Config)
        assert model_config.config.__fn_or_cls__ == Gemma3VLConfig4B
