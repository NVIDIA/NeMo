...
class TestOneLoggerNeMoCallback:
    ...
    def test_inheritance(self):
        ...
        with patch('nemo.utils.callbacks.one_logger_callback.OneLoggerPTLCallback') as mock_ptl_callback, \
    ...
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerConfig')
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerPTLCallback')
    def test_update_config_v1(self, mock_ptl_callback, mock_config_class, mock_get_config, 
                             mock_telemetry_config_class, mock_get_v1_config, mock_provider):
    ...
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerConfig')
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerPTLCallback')
    def test_update_config_v2(self, mock_ptl_callback, mock_config_class, mock_get_config,
                             mock_telemetry_config_class, mock_get_v2_config, mock_provider):
    ...
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerConfig')
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerPTLCallback')
    def test_update_config_unknown_version_defaults_to_v1(self, mock_ptl_callback, mock_config_class, 
                                                         mock_get_config, mock_telemetry_config_class, 
                                                         mock_get_v1_config, mock_provider):
    ...
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerConfig')
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerPTLCallback')
    def test_update_config_v2_without_data(self, mock_ptl_callback, mock_config_class, mock_get_config,
                                          mock_telemetry_config_class, mock_get_v2_config, mock_provider):
    ...
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerConfig')
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerPTLCallback')
    def test_update_config_v2_with_extra_kwargs(self, mock_ptl_callback, mock_config_class, mock_get_config,
                                               mock_telemetry_config_class, mock_get_v2_config, mock_provider):
    ...
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerConfig')
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerPTLCallback')
    def test_init_with_environment_variables(self, mock_ptl_callback, mock_config_class, 
                                           mock_get_config, mock_provider):
    ...
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerConfig')
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerPTLCallback')
    def test_update_config_with_empty_config(self, mock_ptl_callback, mock_config_class, mock_get_config,
                                           mock_telemetry_config_class, mock_get_v1_config, mock_provider):
    ...
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerConfig')
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerPTLCallback')
    def test_update_config_provider_exception_handling(self, mock_ptl_callback, mock_config_class, mock_get_config,
                                                      mock_telemetry_config_class, mock_get_v1_config, mock_provider):
    ...
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerConfig')
    @patch('nemo.utils.callbacks.one_logger_callback.OneLoggerPTLCallback')
    def test_update_config_config_exception_handling(self, mock_ptl_callback, mock_config_class, mock_get_config,
                                                    mock_telemetry_config_class, mock_get_v1_config, mock_provider):
    ...
    def test_callback_instantiation_without_mocks_raises_import_error(self):
        ...
        with patch('nemo.utils.callbacks.one_logger_callback.OneLoggerPTLCallback', side_effect=ImportError("OneLogger not available")):
