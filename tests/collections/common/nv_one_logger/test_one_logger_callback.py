...
def with_onelogger_components(func):
    ...
    def wrapper(*args, **kwargs):
        with patch('nemo.lightning.one_logger_callback.OneLoggerConfig') as mock_config, \
            ...
            return func(*args, **kwargs, 
                       mock_config=mock_config, mock_config_instance=mock_config_instance,
                       mock_exporter=mock_exporter, mock_exporter_instance=mock_exporter_instance,
                       mock_callback=mock_callback, mock_callback_instance=mock_callback_instance,
                       mock_provider=mock_provider, mock_provider_instance=mock_provider_instance,
...
class TestOneLoggerCallback:
    ...
    def test_init_one_logger_success(self, mock_get_config, mock_config, mock_config_instance,
                                   mock_exporter, mock_exporter_instance, mock_callback, 
                                   mock_callback_instance, mock_provider, mock_provider_instance):
    ...
    def test_update_one_logger_config_nemo_v1(self):
        ...
        with patch('nemo.lightning.one_logger_callback.get_nemo_v1_callback_config') as mock_get_v1_config, \
    ...
    def test_update_one_logger_config_nemo_v2(self):
        ...
        with patch('nemo.lightning.one_logger_callback.get_nemo_v2_callback_config') as mock_get_v2_config, \
             patch('nemo.lightning.one_logger_callback.TrainingTelemetryConfig') as mock_config_class, \
             patch('nemo.lightning.one_logger_callback.TrainingTelemetryProvider') as mock_provider:
    ...
    @with_onelogger_enabled
    @with_onelogger_components
    def test_init_one_logger_world_size_in_init_config(self, mock_get_config, mock_config, 
                                                     mock_config_instance, mock_exporter, 
                                                     mock_exporter_instance, mock_callback, 
                                                     mock_callback_instance, mock_provider, 
