...
class TestMetaInfoManager:
    ...
    def test_get_metadata_training(self):
        ...
        assert metadata["train_iterations_target"] == 1000  # max_steps is stored as train_iterations_target
    ...
    def test_get_metadata_with_env_vars(self):
        ...
        with mock.patch.dict(os.environ, env_vars):
            ...
            # world_size defaults to 1 when distributed is not initialized
