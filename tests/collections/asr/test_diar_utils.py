...
class TestSegmentationUtils:
    ...
    """
    @pytest.mark.unit
    @pytest.mark.parametrize("intervals", [[[1, 4], [2, 6], [8, 10], [15, 18]],
                                           [[1, 5], [2, 6], [8, 10], [15, 18]],
                                           [[2, 6], [1, 3], [15, 18], [8, 10]],
                                           [[8, 10], [15, 18], [2, 6], [1, 3]],
    ...
    @pytest.mark.unit
    @pytest.mark.parametrize("intervals", [[[6, 8], [0, 9], [2, 4], [4, 7]],
                                           [[0, 9], [6, 8], [4, 7], [2, 4]],
                                           [[0, 4], [0, 0], [4, 9], [2, 4]],
    ...
    @pytest.mark.unit
    @pytest.mark.parametrize("intervals", [[[0, 1], [1, 9]],
                                           [[0, 0], [0, 9]],
                                           [[0, 9], [0, 9]]])
    @pytest.mark.parametrize("target", [[[0, 9]]])
    ...
    @pytest.mark.unit
    @pytest.mark.parametrize("intervals", [[[0.25, 1.7], [1.5, 3.0], [2.8, 5.0], [5.5, 10.0]], 
