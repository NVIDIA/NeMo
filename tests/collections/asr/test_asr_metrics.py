...
from nemo.collections.asr.metrics.wer import WER, CTCDecoding, CTCDecodingConfig, word_error_rate, word_error_rate_detail
...
class TestWordErrorRate:
    ...
    def test_wer_function(self):
        ...
        assert word_error_rate_detail(hypotheses=['cat'], references=['']) == (float("inf"), 0, float("inf"), float("inf"), float("inf"))
        ...
        assert word_error_rate_detail(hypotheses=[''], references=['ducuti motorcycle'], use_cer=True) == (1.0, 17, 0.0, 1.0, 0.0)
