...
def test_get_bounded_segment():
    segment_start, segment_duration = get_bounded_segment(start_time = 0, total_duration = 10, min_duration = 0.5, max_duration = 3)
    ...
    #test edge cases
    segment_start, segment_duration = get_bounded_segment(start_time = 0, total_duration = 2, min_duration = 0.5, max_duration = 3)
    assert segment_start >= 0
    assert segment_duration >= 0.5
    assert segment_duration <= 3
