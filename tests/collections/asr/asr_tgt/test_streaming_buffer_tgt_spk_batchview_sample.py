...
@pytest.mark.unit
def test_frame_batch_asr_tgt_spk(hybrid_asr_tgt_spk_model, frame_len, total_buffer, expected_tokens_per_chunk, expected_mid_delay, tokens_per_buffer):
    ...
    json_line = {"audio_filepath": "/home/TestData/an4_diarizer/simulated_train/multispeaker_session_0.wav", "offset": 0.007, "duration": 14.046, "text": "illustration the lemon various dishes are frequently ordered add the wine and if necessary a seasoning of cayenne when it will be rain", "num_speakers": 2, "rttm_filepath": "/home/TestData/an4_diarizer/simulated_train/multispeaker_session_0.1919_1988.rttm", "uem_filepath": None, "ctm_filepath": None, "query_speaker_id": "1919", "query_audio_filepath": "/home/TestData/an4_diarizer/simulated_train/multispeaker_session_0.wav", "query_offset": 0.007, "query_duration": 4}
