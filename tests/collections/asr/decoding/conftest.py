...
def an4_val_manifest_corrected(tmp_path_factory, test_data_dir):
    ...
    an4_val_manifest_corrected_path = (
        tmp_path_factory.mktemp("manifests") / "an4_val_corrected.json"
    )
...
def an4_train_manifest_corrected(tmp_path_factory, test_data_dir):
    ...
    an4_train_manifest_corrected_path = (
        tmp_path_factory.mktemp("manifests") / "an4_train_corrected.json"
    )
