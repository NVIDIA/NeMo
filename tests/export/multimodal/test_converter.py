...
class TestMultimodalConverter:
    ...
    def test_split_qkv_weight(self, model_config):
        ...
        qkv_weight = torch.randn(batch_size, model_config.hidden_size // model_config.num_attention_heads, model_config.hidden_size)
        ...
        # Check shapes
        assert result[0][1].shape == (model_config.num_attention_heads, model_config.hidden_size // model_config.num_attention_heads, model_config.hidden_size)
        assert result[1][1].shape == (model_config.num_query_groups, model_config.hidden_size // model_config.num_attention_heads, model_config.hidden_size)
        assert result[2][1].shape == (model_config.num_query_groups, model_config.hidden_size // model_config.num_attention_heads, model_config.hidden_size)

    def test_split_kv_weight(self, model_config):
        # Create a test KV weight tensor
        batch_size = 2 * model_config.num_query_groups
        kv_weight = torch.randn(batch_size, model_config.hidden_size // model_config.num_attention_heads, model_config.hidden_size)
        ...
        # Check shapes
        assert result[0][1].shape == (model_config.num_query_groups, model_config.hidden_size // model_config.num_attention_heads, model_config.hidden_size)
        assert result[1][1].shape == (model_config.num_query_groups, model_config.hidden_size // model_config.num_attention_heads, model_config.hidden_size)
