...
coverage run --concurrency=multiprocessing --branch -a --data-file=/workspace/.coverage --source=/workspace/nemo tests/collections/llm/gpt/model/megatron_ssm_pretraining.py \
    --devices 1 \
    --max-steps 10 \
