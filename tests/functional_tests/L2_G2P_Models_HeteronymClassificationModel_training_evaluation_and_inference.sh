...
cd examples/tts/g2p &&
    ...
    coverage run --concurrency=multiprocessing --branch -a --data-file=/workspace/.coverage --source=/workspace/nemo g2p_heteronym_classification_train_and_evaluate.py \
    ...
    coverage run --concurrency=multiprocessing --branch -a --data-file=/workspace/.coverage --source=/workspace/nemo g2p_heteronym_classification_inference.py \
