...
coverage run --concurrency=multiprocessing --branch -a --data-file=/workspace/.coverage --source=/workspace/nemo examples/multimodal/text_to_image/stable_diffusion/sd_train.py \
    trainer.devices=1 \
    trainer.max_steps=3 \
