...
coverage run -a --data-file=/workspace/.coverage --source=/workspace/nemo -m torch.distributed.launch --nproc_per_node=1 --use-env examples/nlp/machine_translation/enc_dec_nmt.py \
    --config-path=conf \
