...
cd examples/tts/g2p &&
    ...
    coverage run -a --data-file=/workspace/.coverage --source=/workspace/nemo g2p_train_and_evaluate.py \
    ...
    coverage run -a --data-file=/workspace/.coverage --source=/workspace/nemo g2p_inference.py \
