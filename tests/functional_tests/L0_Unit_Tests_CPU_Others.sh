...
CUDA_VISIBLE_DEVICES="" NEMO_NUMBA_MINVER=0.53 coverage run -a --data-file=/workspace/.coverage --source=/workspace/ pytest -m "not pleasefixme" --cpu --with_downloads --relax_numba_compat \
