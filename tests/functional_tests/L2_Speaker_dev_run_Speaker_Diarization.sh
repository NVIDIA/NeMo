...
coverage run -a --data-file=/workspace/.coverage --source=/workspace/nemo -m torch.distributed.launch --nproc_per_node=2 examples/speaker_tasks/diarization/neural_diarizer/multiscale_diar_decoder.py \
