...
class TestCIT52p8b:
    ...
    def test_ci_train_t5_2p8b_80gb_3runs(self):
        ...
        final_summary_csv = os.path.join(BASE_RESULTS_DIR, "t5/2.8b_80gb/final_result/final_summary_20nodes.csv")
        optimal_cfg = os.path.join(BASE_RESULTS_DIR, "t5/2.8b_80gb/final_result/optimal_config_2.8b_20nodes.yaml")
