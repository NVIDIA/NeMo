...
class TestCIGPT126m:
    ...
    def test_ci_train_gpt3_126m_80gb_3runs(self):
        base_cfg = os.path.join(BASE_RESULTS_DIR, "gpt3/0.22b/base_cfg_0.22b.yaml")
        candidate_configs_dir = os.path.join(BASE_RESULTS_DIR, "gpt3/0.22b/candidate_configs")
        training_logs_dir = os.path.join(BASE_RESULTS_DIR, "gpt3/0.22b/training_logs")
        final_result_dir = os.path.join(BASE_RESULTS_DIR, "gpt3/0.22b/final_result")
        final_summary_csv = os.path.join(BASE_RESULTS_DIR, "gpt3/0.22b/final_result/final_summary_1nodes.csv")
        optimal_cfg = os.path.join(BASE_RESULTS_DIR, "gpt3/0.22b/final_result/optimal_config_0.22b_1nodes.yaml")
