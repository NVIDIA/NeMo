...
class TestCIT5220m:
    ...
    def test_ci_train_t5_220m_80gb_3runs(self):
        ...
        final_summary_csv = os.path.join(BASE_RESULTS_DIR, "t5/0.22b_80gb/final_result/final_summary_1nodes.csv")
        optimal_cfg = os.path.join(BASE_RESULTS_DIR, "t5/0.22b_80gb/final_result/optimal_config_0.22b_1nodes.yaml")
