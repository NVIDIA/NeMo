...
class TestCIGPT5b:
    ...
    def test_ci_train_gpt3_5b_80gb_3runs(self):
        ...
        final_summary_csv = os.path.join(BASE_RESULTS_DIR, "gpt3/5b_80gb/final_result/final_summary_1nodes.csv")
        optimal_cfg = os.path.join(BASE_RESULTS_DIR, "gpt3/5b_80gb/final_result/optimal_config_5b_1nodes.yaml")
