...
class TestCIGPT126m:
    ...
    def test_ci_train_gpt3_126m_80gb_3runs(self):
        ...
        final_result_dir = os.path.join(BASE_RESULTS_DIR, "gpt3/0.126b/final_result")
        final_summary_csv = os.path.join(BASE_RESULTS_DIR, "gpt3/0.126b/final_result/final_summary_1nodes.csv")
        optimal_cfg = os.path.join(BASE_RESULTS_DIR, "gpt3/0.126b/final_result/optimal_config_0.126b_1nodes.yaml")
