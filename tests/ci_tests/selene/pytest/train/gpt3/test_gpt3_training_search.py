...
class TestCIGPT126m:
    ...
    def test_ci_train_gpt3_126m_40gb_3runs(self):
        ...
        final_result_dir = os.path.join(BASE_RESULTS_DIR, f"gpt3/{RUN_SIZE}_{GPU_MEM}gb/final_result")
        final_summary_csv = os.path.join(BASE_RESULTS_DIR, f"gpt3/{RUN_SIZE}_{GPU_MEM}gb/final_result/final_summary_{NODES}nodes.csv")
        optimal_cfg = os.path.join(BASE_RESULTS_DIR, f"gpt3/{RUN_SIZE}_{GPU_MEM}gb/final_result/optimal_config_{RUN_SIZE}_{NODES}nodes.yaml")
