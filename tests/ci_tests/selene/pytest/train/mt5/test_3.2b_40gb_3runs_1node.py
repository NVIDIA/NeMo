...
class TestCImT53p2b:
    ...
    def test_ci_train_mt5_3p2b_80gb_3runs(self):
        ...
        final_summary_csv = os.path.join(BASE_RESULTS_DIR, "mt5/3.2b_40gb/final_result/final_summary_1nodes.csv")
        optimal_cfg = os.path.join(BASE_RESULTS_DIR, "mt5/3.2b_40gb/final_result/optimal_config_3.2b_1nodes.yaml")
