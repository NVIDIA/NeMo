...
class TestCIGPT126m:
    ...
    def test_ci_train_gpt3_126m_80gb_3runs(self):
        base_cfg = os.path.join(BASE_RESULTS_DIR, "gpt3/3.2b_80gb/base_cfg_3.2b.yaml")
        candidate_configs_dir = os.path.join(BASE_RESULTS_DIR, "gpt3/3.2b_80gb/candidate_configs")
        training_logs_dir = os.path.join(BASE_RESULTS_DIR, "gpt3/3.2b_80gb/training_logs")
        final_result_dir = os.path.join(BASE_RESULTS_DIR, "gpt3/3.2b_80gb/final_result")
        final_summary_csv = os.path.join(BASE_RESULTS_DIR, "gpt3/3.2b_80gb/final_result/final_summary_1nodes.csv")
        optimal_cfg = os.path.join(BASE_RESULTS_DIR, "gpt3/3.2b_80gb/final_result/optimal_config_3.2b_1nodes.yaml")
