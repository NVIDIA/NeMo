...
class TestCIGPT126m:
    ...
    expected = {
        "reduced_train_loss": {
            ...
            "step_interval": 1,
            "values": [
                10.93451, 10.9697, 10.94154, 10.94307, 10.84738,
                10.47519, 10.44202, 10.07936, 9.7863, 9.69353,
            ],
        },
        "val_loss": {
            "start_step": 0,
            "end_step": 5,
            "step_interval": 1,
            "values": [10.88569, 10.69234, 10.08759, 9.37511, 9.10205],
        },
        "train_step_timing_avg": 0.916,
    }
