HYDRA_FULL_ERROR=1 python3 main.py \
    ...
    "training_container='${BUILD_IMAGE_NAME_TRAINING}'" \
    "inference_container='${BUILD_IMAGE_NAME_INFERENCE}'" \
    "cluster.env.training_container_image='${BUILD_IMAGE_NAME_TRAINING}'" \
    "cluster.env.inference_container_image='${BUILD_IMAGE_NAME_INFERENCE}'" \
