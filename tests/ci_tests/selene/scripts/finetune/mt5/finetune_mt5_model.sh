...
HYDRA_FULL_ERROR=1 BIGNLP_CI=1 python3 main.py \
    ...
    fine_tuning.model.restore_from_path=${BASE_RESULTS_DIR}/convert_${RUN_MODEL}_${RUN_MODEL_SIZE}_tp${TP_SIZE}_pp${PP_SIZE}/results/megatron_mt5.nemo \
