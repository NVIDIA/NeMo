HYDRA_FULL_ERROR=1 python3 main.py \
    ...
    evaluation.run.model_train_name=gpt3_126m_tp1_pp2 \
    evaluation.run.train_dir=${BASE_RESULTS_DIR}/train_gpt3_126m_tp1_pp2_2node_100steps \
    ...
    evaluation.model.pipeline_model_parallel_size=2
