HYDRA_FULL_ERROR=1 python3 main.py \
    ...
    export.run.model_train_name=mt5_170m_tp1_pp1 \
    export.run.results_dir=${BASE_RESULTS_DIR}/${RUN_NAME} \
    export.model.checkpoint_path=${BASE_RESULTS_DIR}/finetune_mt5_170m_tp1_pp1_1node_100steps_xnli/checkpoints/megatron_mt5_glue_xnli.nemo \
