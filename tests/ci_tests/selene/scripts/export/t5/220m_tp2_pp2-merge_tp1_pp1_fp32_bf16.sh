HYDRA_FULL_ERROR=1 python3 main.py \
    ...
    export.run.model_train_name=t5_220m_tp2_pp2 \
    export.run.results_dir=${BASE_RESULTS_DIR}/${RUN_NAME} \
    export.model.checkpoint_path=${BASE_RESULTS_DIR}/finetune_t5_220m_tp2_pp2_2node_100steps_mnli/checkpoints/megatron_t5_glue.nemo \
