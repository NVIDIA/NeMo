...
HYDRA_FULL_ERROR=1 BIGNLP_CI=1 python3 main.py \
    ...
    export.model.checkpoint_path=${BASE_RESULTS_DIR}/finetune_t5_${RUN_MODEL_SIZE}_tp${TP_SIZE}_pp${PP_SIZE}_${PP_SIZE}node_100steps_mnli/results/checkpoints/megatron_t5_glue.nemo \
