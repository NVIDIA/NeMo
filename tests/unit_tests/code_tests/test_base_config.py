...
class TestGenerateBaseconfig:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # BERT tests
            (0.11, 8, 8, 80, 2, 300, 30522, "bert", {"search_config": {"train_settings": {"logs": "."}}, "bignlp_hp_tool_path": ".", "wandb": {"enable": True, "project": "test_project"}}, {"name": "bert_0.11b", "time_limit": "2-00:00:00", "max_steps": 2288818, "max_time": "2:00:30:00", "num_layers": 12, "gbs": 256, "hs": 768, "att_heads": 12, "ffn": "${multiply:4, ${.hidden_size}}", "kv": "null", "init_std": 0.023094, "lr": 2e-4, "min_lr": 2e-5, "warmup_steps": 3433, "constant_steps": 379943, "warmup_ratio": None}),
            (4.0, 16, 8, 80, 7, 300, 30522, "bert", {"search_config": {"train_settings": {"logs": "."}}, "bignlp_hp_tool_path": ".", "wandb": {"enable": True, "project": "test_project"}}, {"name": "bert_4.0b", "time_limit": "7-00:00:00", "max_steps": 286102, "max_time": "7:00:30:00", "num_layers": 48, "gbs": 2048, "hs": 2560, "att_heads": 32, "ffn": "${multiply:4, ${.hidden_size}}", "kv": "null", "init_std": 0.012649, "lr": 1e-4, "min_lr": 1e-5, "warmup_steps": 429, "constant_steps": 47492, "warmup_ratio": None}),
            (20.0, 64, 8, 80, 12, 300, 30522, "bert", {"search_config": {"train_settings": {"logs": "."}}, "bignlp_hp_tool_path": ".", "wandb": {"enable": True, "project": "test_project"}}, {"name": "bert_20.0b", "time_limit": "12-00:00:00", "max_steps": 286102, "max_time": "12:00:30:00", "num_layers": 48, "gbs": 2048, "hs": 6144, "att_heads": 48, "ffn": "${multiply:4, ${.hidden_size}}", "kv": "null", "init_std": 0.008165, "lr": 1e-4, "min_lr": 1e-5, "warmup_steps": 429, "constant_steps": 47492, "warmup_ratio": None}),
        ],
    )
