...
class TestCalculateTpPpMbsGrid:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (0.126, 12, "gpt3", {"tensor_parallel_sizes": "auto", "pipeline_parallel_sizes": "auto", "micro_batch_sizes": "auto", "gpu_memory_gb": 80}, {"tp": [1,2], "pp": [1], "mbs": [1,2,3,4,6,8]}),
            (2.5, 24, "gpt3", {"tensor_parallel_sizes": "auto", "pipeline_parallel_sizes": "auto", "micro_batch_sizes": "auto", "gpu_memory_gb": 80}, {"tp": [1,2,4], "pp": [1], "mbs": [1,2,3,4,6,8]}),
            ...
            (175.0, 96, "gpt3", {"tensor_parallel_sizes": "auto", "pipeline_parallel_sizes": "auto", "micro_batch_sizes": "auto", "gpu_memory_gb": 80}, {"tp": [8], "pp": [4,6,8,12,16], "mbs": [1,2,4]}),
            # T5 tests
