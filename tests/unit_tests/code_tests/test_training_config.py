...
class TestCalculateTpPpMbsGrid:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (20.0, 48, "bert", {"tensor_parallel_sizes": "auto", "pipeline_parallel_sizes": "auto", "micro_batch_sizes": "auto", "gpu_memory_gb": 80, "min_model_parallel_size": "auto", "max_model_parallel_size": "auto"}, {"tp": [4,8], "pp": [1], "mbs": [1,2,3,4], "min_par": 4, "max_par": 8}),
        ],
    )
