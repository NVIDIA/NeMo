...
def train(
    ...
    Args:
        ...
        peft: Optional PEFT instance for parameter efficient fine-tuning. Used to selectively save adapter weights.
...
def save_checkpoint_and_time(
    ...
    Args:
        ...
        peft: Optional PEFT instance for parameter efficient fine-tuning.
    """
    timers = state.timers
