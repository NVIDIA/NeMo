...
class HFLlamaNemotronImporter(BaseImporter):
    ...
    def init_hf_model(self):
        ...
        return AutoModelForCausalLM.from_pretrained(str(self.input_path), trust_remote_code=True, torch_dtype='auto')

    convert_state = _NeMo2HFLlamaNemotronImporter.convert_state
    ...
    def hf_config(self) -> "HFLlamaConfig":
        ...
        if self._hf_config is not None:
            return self._hf_config
        self._hf_config = AutoConfig.from_pretrained(str(self.input_path), trust_remote_code=True)
        return self._hf_config

    @property
    def tron_config(self):
        ...
        self._tron_config = _NeMo2HFLlamaNemotronImporter.config.fget(self.input_path)
        return self._tron_config
