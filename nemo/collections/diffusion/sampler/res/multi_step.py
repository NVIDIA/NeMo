...
"""
Implementation of multistep methods to solve the ODE in the diffusion model.
"""
...
def order2_fn(
    ...
    """
    Implementation of the second order multistep method in https://arxiv.org/pdf/2308.02157
