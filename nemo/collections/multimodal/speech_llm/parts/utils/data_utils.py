...
def write_predictions_to_file(cfg: DictConfig, predictions: list, model: ModelPT):
    if model.global_rank == 0:
        ...
        if cfg.inference.outfile_path is not None:
            ...
            logging.info("predictions saved to {}".format(cfg.inference.outfile_path))
        else:
            logging.info(f"No outfile path provided, skipping writing predictions to file.")
