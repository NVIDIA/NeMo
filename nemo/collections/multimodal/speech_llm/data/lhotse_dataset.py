...
def collate_text_data(
    ...
    input_id_maxlen = min(max_seq_length, get_max_len(fields["input_ids"]))
    context_id_maxlen = min(max_seq_length, tokens_to_generate + get_max_len(fields["context_ids"]))
    answer_id_maxlen = min(max_seq_length, get_max_len(fields["answer_ids"]))
