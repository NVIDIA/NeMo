...
from nemo.collections.multimodal.modules.stable_diffusion.diffusionmodules.util import make_ddim_sampling_parameters, \
...
class AbstractBaseSampler(ABC):
    ...
    @torch.no_grad()
    def sampling_fn(self, cond, shape,
        ...
        for i, step in enumerate(iterator):
            ...
            outs = self.p_sampling_fn(img, cond, ts, index=index, use_original_steps=ddim_use_original_steps,
    ...
    def _get_model_output(self, x, t, unconditional_conditioning, unconditional_guidance_scale, score_corrector, c,
                          corrector_kwargs):
    ...
    def _get_x_prev_and_pred_x0(self, use_original_steps, b, index, device, x, e_t, quantize_denoised, repeat_noise,
