...
from nemo.collections.multimodal.models.generative.controlnet.uniformer.mmcv.runner import force_fp32
...
class PointsSampler(nn.Module):
    ...
    def __init__(
        self, num_point: List[int], fps_mod_list: List[str] = ['D-FPS'], fps_sample_range_list: List[int] = [-1]
    ):
        super().__init__()
