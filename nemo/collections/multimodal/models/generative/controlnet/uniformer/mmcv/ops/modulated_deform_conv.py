...
from nemo.collections.multimodal.models.generative.controlnet.uniformer.mmcv.utils import deprecated_api_warning
...
class ModulatedDeformConv2dFunction(Function):
    ...
    @staticmethod
    def forward(
        ctx, input, offset, mask, weight, bias=None, stride=1, padding=0, dilation=1, groups=1, deform_groups=1
    ):
