...
from nemo.collections.multimodal.models.generative.controlnet.uniformer.mmcv.utils.ext_loader import check_ops_exist
...
class DefaultOptimizerConstructor:
    ...
    def _validate_cfg(self):
        ...
        if 'custom_keys' in self.paramwise_cfg:
            if not isinstance(self.paramwise_cfg['custom_keys'], dict):
                raise TypeError(
                    'If specified, custom_keys must be a dict, ' f'but got {type(self.paramwise_cfg["custom_keys"])}'
                )
    ...
    def add_params(self, params, module, prefix='', is_dcn_module=None):
        ...
        if check_ops_exist():
            from nemo.collections.multimodal.models.generative.controlnet.uniformer.mmcv.ops import (
                DeformConv2d,
