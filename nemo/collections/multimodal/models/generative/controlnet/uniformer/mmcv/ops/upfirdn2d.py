...
from nemo.collections.multimodal.models.generative.controlnet.uniformer.mmcv.utils import to_2tuple
...
def upfirdn2d(input, kernel, up=1, down=1, pad=(0, 0)):
    ...
    if input.device.type == 'cpu':
        ...
        out = upfirdn2d_native(input, kernel, up[0], up[1], down[0], down[1], pad[0], pad[1], pad[2], pad[3])
    else:
        _up = to_2tuple(up)
