...
class EvalHook(_EvalHook):
    ...
    def after_train_iter(self, runner):
        ...
        if self.by_epoch or not self.every_n_iters(runner, self.interval):
            return
        from nemo.collections.multimodal.models.generative.controlnet.uniformer.mmseg.apis import single_gpu_test
...
class DistEvalHook(_DistEvalHook):
    ...
    def after_train_iter(self, runner):
        ...
        if self.by_epoch or not self.every_n_iters(runner, self.interval):
            return
        from nemo.collections.multimodal.models.generative.controlnet.uniformer.mmseg.apis import multi_gpu_test
