...
from nemo.collections.multimodal.models.generative.controlnet.uniformer.mmseg.apis import (
    inference_segmentor,
    init_segmentor,
    show_result_pyplot,
)
from nemo.collections.multimodal.models.generative.controlnet.uniformer.mmseg.core.evaluation import get_palette
...
class UniformerDetector:
    def __init__(self):
        annotator_ckpts_path = '/opt/NeMo/nemo/collections/multimodal/models/controlnet/uniformer'
