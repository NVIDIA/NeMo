...
from nemo.collections.multimodal.models.text_to_image.controlnet.uniformer.mmseg.apis import (
    inference_segmentor,
    init_segmentor,
    show_result_pyplot,
)
from nemo.collections.multimodal.models.text_to_image.controlnet.uniformer.mmseg.core.evaluation import get_palette
