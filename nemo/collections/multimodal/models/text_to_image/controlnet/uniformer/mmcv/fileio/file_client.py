...
from nemo.collections.multimodal.models.text_to_image.controlnet.uniformer.mmcv.utils.misc import has_method
from nemo.collections.multimodal.models.text_to_image.controlnet.uniformer.mmcv.utils.path import is_filepath
...
class FileClient:
    ...
    @classmethod
    def infer_client(
        cls, file_client_args: Optional[dict] = None, uri: Optional[Union[str, Path]] = None
    ) -> 'FileClient':
