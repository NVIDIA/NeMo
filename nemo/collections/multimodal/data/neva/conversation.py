...
class Conversation:
    ...
    sep: str = "###"
    sep2: str = None  # sep before system
    version: str = "Unknown"
        ...
        if self.sep_style == SeparatorStyle.MPT:
            ...
            for role, message in self.messages:
                if message:
                    ...
                    ret += role
            return ret
        if self.sep_style == SeparatorStyle.NVGPT:
...
conv_nvgpt_text = conv_nvgpt
simple_conv_nvgpt_multimodal = conv_nvgpt
...
conv_templates = {
    ...
    "nvgpt_multimodal": simple_conv_nvgpt_multimodal,
    "neva_v1": conv_neva_v1,
    # fastchat
    "v1": conv_v1_2,
