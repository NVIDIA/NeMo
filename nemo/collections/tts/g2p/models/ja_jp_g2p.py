...
from nemo.collections.common.tokenizers.text_to_speech.ipa_lexicon import get_grapheme_character_set, get_ipa_punctuation_list
...
class JapaneseG2p(BaseG2p):
    def __init__(
        ...
        assert word_segmenter == 'janome', f"{word_segmenter} is not supported now. Please choose correct word_segmenter."
        ...
        self.punctuation = sorted(list(punct_set))
