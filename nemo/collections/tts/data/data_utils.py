...
def get_sup_data_file_path(entry: dict, base_audio_path: Path, base_sup_path: Path, data_type: str) -> Path:
    ...
    file_path = Path(os.path.join(base_sup_path, data_type, file_name))
    return file_path
