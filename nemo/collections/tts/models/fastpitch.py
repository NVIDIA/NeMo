...
class FastPitchModel(SpectrogramGenerator, Exportable):
    ...
    def list_available_models(cls) -> 'List[PretrainedModelInfo]':
        ...
        # zh, single female speaker, 22050Hz, SFSpeech Bilingual Chinese/English dataset, initial model.
        model = PretrainedModelInfo(
            pretrained_model_name="tts_zh_fastpitch_sfspeech_r1_14",
            ...
            " sampled at 22050Hz and can be used to generate female Mandarin Chinese voices.",
            class_=cls,
        )
        list_of_models.append(model)
        ...
        model = PretrainedModelInfo(
            pretrained_model_name="tts_zh_fastpitch_sfspeech_r1_15",
