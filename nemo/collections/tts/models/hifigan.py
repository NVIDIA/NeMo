...
class HifiGanModel(Vocoder, Exportable):
    ...
    def list_available_models(cls) -> 'Optional[Dict[str, str]]':
        ...
        model = PretrainedModelInfo(
            pretrained_model_name="tts_zh_hifigan_sfspeech_r1_14",
            ...
            " by the mel-spectrograms generated from the FastPitch checkpoint `tts_zh_fastpitch_sfspeech_r1_14`."
        ...
        model = PretrainedModelInfo(
            pretrained_model_name="tts_zh_hifigan_sfspeech_r1_15",
            ...
            description="This model is finetuned from the HiFiGAN pretrained checkpoint `tts_en_lj_hifigan_ft_mixerttsx`"
            " by the mel-spectrograms generated from the FastPitch checkpoint `tts_zh_fastpitch_sfspeech_r1_15`."
            " This model has been tested on generating female Mandarin Chinese voices.",
            class_=cls,
        )
        list_of_models.append(model)
