...
class TELinearWithFp8Padding(TELinear):
    def forward(self, x): return fp8_padded_forward(super(), self, x)

class TELayerNormColumnParallelLinearWithFp8Padding(TELayerNormColumnParallelLinear):
    def forward(self, x): return fp8_padded_forward(super(), self, x)

class RMSNormTELinearWithFp8Padding(TELinearWithFp8Padding):
    """
