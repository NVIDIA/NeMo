...
from megatron.core import parallel_state, InferenceParams, tensor_parallel
...
from nemo.collections.llm.gpt.model.megatron.hyena.hyena_utils import get_init_method, reweighted_cross_entropy, make_upper_case
