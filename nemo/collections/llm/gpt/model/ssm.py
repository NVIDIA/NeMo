...
class SSMConfig(TransformerConfig, io.IOMixin):
    ...
    def configure_model(
        ...
        return MCoreMambaModel(
            ...
            pre_process=pre_process or parallel_state.is_pipeline_first_stage(ignore_virtual=True),
            post_process=post_process or parallel_state.is_pipeline_last_stage(ignore_virtual=True),
        )
