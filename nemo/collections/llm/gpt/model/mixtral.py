...
class MixtralModel(GPTModel):
    def __init__(self, config: Optional[MixtralConfig] = None, tokenizer=None):
        _tokenizer = tokenizer or HFMixtralImporter().tokenizer

        super().__init__(config or MixtralConfig(), _tokenizer)


@io.model_importer(MixtralModel, ext="hf", default_path="mistralai/Mixtral-8x7B-v0.1")
