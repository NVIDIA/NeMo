...
class NemotronConfig(GPTConfig):
    ...
    ub_tp_comm_overlap: bool = True


@dataclass
class NemotronConfig4B(NemotronConfig):
    num_layers: int = 32
    seq_length: int = 4096
    hidden_size: int = 3072
    ffn_hidden_size: int = 9216
...
@dataclass
class NemotronConfig8B(NemotronConfig):
    num_layers: int = 32
    seq_length: int = 4096
...
@dataclass
class NemotronConfig15B(NemotronConfig):
    num_layers: int = 32
    seq_length: int = 4096
...
@dataclass
class NemotronConfig22B(NemotronConfig):
    num_layers: int = 40
    seq_length: int = 4096
    hidden_size: int = 6144
    ffn_hidden_size: int = 24576
...
@dataclass
class NemotronConfig340B(NemotronConfig):
    num_layers: int = 96
    seq_length: int = 4096
