...
class PreTrainingDataModule(pl.LightningDataModule, IOMixin):
    ...
    def __init__(
        ...
        eval_micro_batch_size: Union[int,None] = None,
        global_batch_size: int = 8,
        eval_global_batch_size: Union[int,None] = None,
        ...
        if eval_global_batch_size is None:
            self.eval_global_batch_size = self.global_batch_size
        else:
            self.eval_global_batch_size = eval_global_batch_size
    ...
    def build(
        ...
        num_val_samples = int(eval_iters * self.eval_global_batch_size)
