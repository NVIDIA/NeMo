...
def trainer(
    ...
    """
    Configure the NeMo Lightning Trainer for Llama-3.3-Nemotron-Super-49B model.

    This function sets up the distributed training strategy optimized for the Llama-3.3-Nemotron-Super-49B model.
    ...
    Examples:
        CLI usage:
            $ nemo llm pretrain trainer=llama33_nemotron_super_49b ...
...
def pretrain_recipe(
    ...
    """
    Create a pre-training recipe for Llama-3.3-Nemotron-Super-49B model.
    ...
    Examples:
        CLI usage:
            ...
            $ nemo llm pretrain --factory "llama33_nemotron_super_49b(num_nodes=1, name='my_super_pretrain')"
    ...
    Note:
        This recipe is optimized for the Llama-3.3-Nemotron-Super-49B model
