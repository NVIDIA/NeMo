...
def pretrain_recipe_performance(
    ...
    Examples:
        CLI usage:
            $ nemo llm pretrain --factory "llama31_405b.pretrain_recipe_performance(num_nodes=72, name='perf_pretrain')"

        Python API usage:
            >>> recipe = pretrain_recipe_performance(name="llama31_405b_perf", num_nodes=72)
            >>> print(recipe)
