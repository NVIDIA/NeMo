...
def model() -> run.Config[pl.LightningModule]:
    ...
    Examples:
        ...
        Python API usage:
            ...
            >>> print(model_config)
    """
    return run.Config(llm.GPTModel, config=run.Config(llm.BaseMambaConfig780M))
...
def pretrain_recipe_performance(
    ...
    """
    Create a performance-optimized pre-training recipe for Mamba2 780M model.
    ...
    Examples:
            $ nemo llm pretrain --factory mamba2_780m_optimized

        Python API usage:
            >>> recipe = pretrain_recipe_performance(name="mamba2_780m_perf", num_nodes=1)
            >>> print(recipe)
