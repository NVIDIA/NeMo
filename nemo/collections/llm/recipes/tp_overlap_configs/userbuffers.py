...
userbuffers_fp8_h100_h8192_tp4_mbs1_seqlen8192 = {
    ...
    'fc1_fprop': {'method': 'ring_exchange', 'aggregate': 0}, 
    'fc2_dgrad': {'method': 'ring_exchange', 'aggregate': 0}, 
    'proj_fprop': {'method': 'pipeline', 'num_sm': 24, 'cga_size': 2, 'num_splits': 4, 'set_sm_margin': 1, 'fp8_buf': 1}, 
    'fc2_fprop': {'method': 'pipeline', 'num_sm': 16, 'cga_size': 2, 'num_splits': 4, 'set_sm_margin': 1, 'fp8_buf': 1}
}
