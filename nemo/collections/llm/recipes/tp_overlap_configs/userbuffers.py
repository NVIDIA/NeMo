...
# llama3 70b LoRA
userbuffers_fp8_h100_h8192_tp2_mbs1_seqlen8192_lora = TransformerLayerTPOverlapCfg(
    qkv_dgrad=BulkOverlapCfg(num_sm=2, cga_size=2, set_sm_margin=False),
    qkv_wgrad=None,
    fc1_dgrad=BulkOverlapCfg(num_sm=1, cga_size=2, set_sm_margin=False),
    fc1_wgrad=None,
...
userbuffers_fp8_h100_h8192_tp4_mbs1_seqlen8192_lora = TransformerLayerTPOverlapCfg(
    qkv_dgrad=BulkOverlapCfg(num_sm=4, cga_size=2, set_sm_margin=False),
    qkv_wgrad=None,
