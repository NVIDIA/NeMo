...
NAME = "qwen3_480b_a35b"


@run.cli.factory(name=NAME)
def model() -> run.Config[pl.LightningModule]:
    """
    Factory function to create a Qwen3 480B-A35B model configuration.
    This is a MoE (Mixture of Experts) model with 128 experts.

    Returns:
        run.Config[pl.LightningModule]: Configuration for the Qwen3 480B-A35B model.

    Examples:
        CLI usage:
            $ nemo llm pretrain model=qwen3_480b_a35b ...
...
def pretrain_recipe(
    ...
    """
    Create a pre-training recipe for Qwen3 480B-A35B model.
    ...
    Examples:
        CLI usage:
            $ nemo llm pretrain --factory qwen3_480b_a35b
            $ nemo llm pretrain --factory "qwen3_480b_a35b(num_nodes=1, name='my_qwen3_pretrain')"
...
def finetune_recipe(
    ...
    """
    Create a fine-tuning recipe for Qwen3 480B-A35B model.
    ...
    Examples:
        CLI usage:
            $ nemo llm finetune --factory qwen3_480b_a35b

        Python API usage:
            >>> recipe = finetune_recipe(name="qwen3_480b_a35b_finetune", num_nodes=8)
            >>> print(recipe)
    ...
    recipe = default_finetune_recipe(
        model(), "Qwen/Qwen3-480B-A35B", dir, name, num_nodes, num_gpus_per_node, packed_sequence
    )
