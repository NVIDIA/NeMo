...
from nemo.collections.llm.gpt.model.mistral import MistralNeMo2407Config12B, MistralModel
...
def finetune_recipe(
    ...
    """
    Create a fine-tuning recipe for Mistral-Nemo-Base-2407 model.
    ...
    Examples:
        CLI usage:
            $ nemo llm finetune --factory mistral_nemo_base_2407
            $ nemo llm finetune --factory "mistral_nemo_base_2407(num_nodes=2, name='my_mistral_finetune')"
