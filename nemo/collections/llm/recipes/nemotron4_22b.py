...
def model() -> run.Config[pl.LightningModule]:
    ...
    Examples:
        ...
        Python API usage:
            ...
            >>> print(model_config)
    """
    return run.Config(NemotronModel, config=run.Config(Nemotron4Config22B))
...
def trainer(
    ...
    """
    Configure the NeMo Lightning Trainer for Nemotron4 22B model.
    ...
    Examples:
        CLI usage:
            $ nemo llm pretrain trainer=nemotron4_22b ...
...
def pretrain_recipe(
    ...
    Examples:
        CLI usage:
            ...
            $ nemo llm pretrain --factory "nemotron4_22b(num_nodes=2, name='my_pretrain')"

        Python API usage:
            >>> recipe = pretrain_recipe(name="nemotron4_22b_pretrain", num_nodes=2)
            >>> print(recipe)
...
def hf_resume() -> run.Config[nl.AutoResume]:
    ...
    """
    raise NotImplementedError("Nemotron4 22b is not supported on huggingface")
...
def finetune_recipe(
    ...
    """
    Create a fine-tuning recipe for Nemotron4 22B model.
    ...
    Examples:
        CLI usage:
            $ nemo llm finetune --factory nemotron4_22b

        Python API usage:
            >>> recipe = finetune_recipe(name="nemotron4_22b_finetune", num_nodes=2)
            >>> print(recipe)
