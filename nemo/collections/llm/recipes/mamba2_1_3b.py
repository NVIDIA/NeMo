...
def pretrain_recipe(
    ...
    Examples:
        CLI usage:
            $ nemo llm pretrain --factory mamba2_1.3B
...
def pretrain_recipe_performance(
    ...
    """
    Create a performance-optimized pre-training recipe for Mamba2 1.3B model.
    ...
    Examples:
            $ nemo llm pretrain --factory mamba2_1_3b_optimized

        Python API usage:
            >>> recipe = pretrain_recipe_performance(name="mamba2_1_3b_perf", num_nodes=1)
            >>> print(recipe)
