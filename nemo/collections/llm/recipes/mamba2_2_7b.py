...
def model() -> run.Config[pl.LightningModule]:
    ...
    Examples:
        ...
        Python API usage:
            ...
            >>> print(model_config)
    """
    return run.Config(llm.GPTModel, config=run.Config(llm.BaseMambaConfig2_7B))
...
def pretrain_recipe(
    ...
    Examples:
        CLI usage:
            $ nemo llm pretrain --factory mamba2_2.7B
...
def pretrain_recipe_performance(
    ...
    """
    Create a performance-optimized pre-training recipe for Mamba2 2.7B model.
    ...
    Examples:
            $ nemo llm pretrain --factory mamba2_2_7b_optimized

        Python API usage:
            >>> recipe = pretrain_recipe_performance(name="mamba2_2_7b_perf", num_nodes=1)
            >>> print(recipe)
