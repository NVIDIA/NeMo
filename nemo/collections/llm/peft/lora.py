...
def patch_linear_module(
    ...
    if getattr(orig_linear, 'quant_state', None) is not None and orig_linear.quant_state.__class__ == bitsandbytes.functional.QuantState:
        ...
        if (ans := self.match(m, name, prefix)) is not None:
            ...
            if isinstance(m, nn.Linear) or m.__class__ == te.Linear:
                ...
                if (
                    ...
                    or (getattr(m, 'quant_state', None) is not None and m.quant_state.__class__ == bitsandbytes.functional.QuantState)
                ):
