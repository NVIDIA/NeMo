...
from nemo.collections.common.losses.multi_similarity_loss import \
    MultiSimilarityLoss
from nemo.collections.common.losses.smoothed_cross_entropy import (
    SmoothedCrossEntropyLoss, SmoothedNLLLoss)
