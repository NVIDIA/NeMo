...
def get_tokenizer(
    ...
    Args:
        ...
        special_tokens: dict of special tokens. 
            For additional special tokens besides standard special tokens (bos, eos, pad, etc.), such as sentinel tokens for T5 (<extra_id_0>, <extra_id_1>, etc.), use key 'other_special_tokens'
...
def get_nmt_tokenizer(
    ...
    if library == 'huggingface':
        ...
        return get_tokenizer(
            tokenizer_name=model_name, vocab_file=vocab_file, merges_file=merges_file, special_tokens=special_tokens_dict, chat_template=chat_template
        )
