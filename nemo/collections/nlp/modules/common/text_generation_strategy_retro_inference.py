...
from nemo.collections.nlp.modules.common.megatron.bert_service import start_sentence_bert_server, pad_batch
...
class RetroQAModelTextGenerationStrategy(TextGenerationStrategy):
