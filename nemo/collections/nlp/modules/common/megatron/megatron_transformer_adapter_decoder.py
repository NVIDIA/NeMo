...
__all__ = ["MegatronTransformerAdapterDecoderModule"]


class MegatronTransformerAdapterDecoderModule(MegatronTransformerDecoderModule, adapter_mixins.AdapterModuleMixin):
