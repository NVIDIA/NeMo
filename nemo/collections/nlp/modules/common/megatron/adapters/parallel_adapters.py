...
from nemo.collections.common.parts.adapter_modules import AbstractAdapterModuleMixin
...
class InfusedAdapter(nn.Module, AbstractAdapterModuleMixin):
    def __init__(
...
class ParallelLinearAdapter(nn.Module, AbstractAdapterModuleMixin):
    def __init__(
        self,
        in_features: int,
        dim: int,
