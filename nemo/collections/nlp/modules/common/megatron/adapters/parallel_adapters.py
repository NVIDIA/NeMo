...
from nemo.collections.common.parts.adapter_modules import AbstractAdapterMixin
...
class InfusedAdapter(nn.Module, AbstractAdapterMixin):
    def __init__(
...
class ParallelLinearAdapter(nn.Module, AbstractAdapterMixin):
    def __init__(
        self,
        in_features: int,
        dim: int,
