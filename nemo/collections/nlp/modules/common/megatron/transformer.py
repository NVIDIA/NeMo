...
class ParallelMLP(MegatronModule):
    ...
    def __init__(
        ...
        # Project to 4h.
        self.dense_h_to_4h = tensor_parallel.ColumnParallenLinear(
            hidden_size,
        ...
        if activation in ['geglu', 'reglu', 'swiglu']:
            ...
            self.dense_h_to_4h_2 = tensor_parallel.ColumnParallenLinear(
                hidden_size,
...
class ParallelAttention(MegatronModule):
    ...
    def __init__(
        ...
        if attention_type == AttnType.self_attn:
            self.query_key_value = tensor_parallel.ColumnParallenLinear(
                hidden_size,
                3 * projection_size,
                gather_output=False,
                init_method=init_method,
            ...
            self.query = tensor_parallel.ColumnParallenLinear(
                hidden_size,
                projection_size,
                gather_output=False,
                init_method=init_method,
            ...
            self.key_value = tensor_parallel.ColumnParallenLinear(
                hidden_size,
                2 * projection_size,
                gather_output=False,
                init_method=init_method,
