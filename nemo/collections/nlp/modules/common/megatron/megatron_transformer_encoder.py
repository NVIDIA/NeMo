...
AVAILABLE_ENCODERS = ["MegatronTransformerEncoderModel"]


class MegatronTransformerEncoderModel(MegatronModule):
    ...
    def __init__(
        ...
        super(MegatronTransformerEncoderModel, self).__init__()
