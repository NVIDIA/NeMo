...
class NLPDDPStrategy(DDPStrategy):
    ...
    def _get_param_group(self, state_dict: Dict[str, Any]):
        ...
        return  state_dict['optimizer_states'][0]['param_groups'] if 'optimizer' not in state_dict['optimizer_states'][0] else state_dict['optimizer_states'][0]['optimizer']['param_groups']
    ...
    def _fix_param_groups(self, checkpoint_path: Union[str, Path], sharded_state_dict: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        if checkpoint_has_expert_param and not model_has_expert_param:
            ...
            if expert_index:
                ...
                model_param_groups.insert(
                    expert_index, {'params': LocalNonpersitentObject([]), 'is_expert': True}
                )
