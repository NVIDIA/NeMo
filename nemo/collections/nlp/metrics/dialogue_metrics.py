...
class DialogueGenerationMetrics(object):
    ...
    def get_bleu(generated_field, ground_truth_field):
        ...
        """
        valid_indices = [i for i in range(len(generated_field)) if generated_field[i] and generated_field[i].strip() and ground_truth_field[i] and ground_truth_field[i].strip()]
