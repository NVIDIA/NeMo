...
from nemo.collections.nlp.data.dialogue.input_example.assistant_input_example import \
    DialogueAssistantInputExample
...
from nemo.collections.nlp.data.dialogue.input_example.sgd_input_example import (
    DialogueSGDInputExample, SGDInputExample)
