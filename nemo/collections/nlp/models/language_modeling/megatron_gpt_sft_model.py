...
class MegatronGPTSFTModel(MegatronGPTModel):
    ...
    def update_for_speech(self):
        ...
        new_embeddings = tensor_parallel.VocabParallelEmbedding(
            num_embeddings=old_token_size + 8 * 1024, embedding_dim=word_embedding.embedding_dim  # TODO
        )
        ...
        # base_module.speech_residual_model_2 = SimplestModule(hidden_size, 1024)
