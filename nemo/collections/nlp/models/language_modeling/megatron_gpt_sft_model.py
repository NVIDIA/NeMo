    ...
    def _build_dataset(self, data_cfg, is_train=True):
        ...
        for file_path, num_samples in zip(data_cfg.file_names, num_train_samples_per_dataset):
            dataset = GPTSFTDataset(
                ...
                tokens_to_generate=data_cfg.get('tokens_to_generate', 0)  # used at inference time to allocate tensor positions for tokens that will be generated by inf procedure.
            )
