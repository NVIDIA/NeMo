...
try:
    ...
    from megatron.core.num_microbatches_calculator import get_current_global_batch_size, get_num_microbatches, get_micro_batch_size, reconfigure_num_microbatches_calculator
