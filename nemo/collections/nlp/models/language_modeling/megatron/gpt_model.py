...
class GPTModel(MegatronModule):
    ...
    def __init__(
        ...
        hidden_dropout=0.1,
        fused_softmax_in_fp16=False,
        fused_softmax_in_bf16=False,
        ...
        self.language_model, self._language_model_key = get_language_model(
            ...
            fused_softmax_input_in_fp16=fused_softmax_in_fp16,
            fused_softmax_input_in_bf16=fused_softmax_in_bf16,
