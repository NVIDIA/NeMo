    ...
    def setup_training_data(self, training_data_config=None):
        if self.cfg.data.train_ds.get("path") or self.cfg.data.get('train_ds', None):
            ...
            self._train_ds, self._train_dl = self.build_virtual_prompt_dataset(
                ...
                for_train=True,
                drop_last=True,
                shuffle=self.cfg.data.train_ds.get("shuffle", self.cfg.data.get("shuffle", True)),
                num_workers=self.cfg.data.train_ds.get("num_workers", self.cfg.data.get("num_workers", 1)),
                pin_memory=self.cfg.data.train_ds.get("pin_memory", self.cfg.data.get("pin_memory", True)),
            )
