...
class MegatronGPTPTuningModel(MegatronGPTPEFTModel):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer):
        ...
        self.trainable_keys = self.adapter_keys - set(["model.language_model.adapter_layer.ptuning_adapter.inference_table.prompt_table.taskname.prompt_embeddings.weight"])
