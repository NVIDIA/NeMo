...
class MegatronGPTModel(MegatronBaseModel, TextGeneration):
    ...
    def build_train_valid_test_datasets(self):
        ...
        if type(self.cfg.data.data_prefix) == DictConfig:
            assert self.cfg.data.data_prefix.get('train') != None and self.cfg.data.data_prefix.get('test') != None and self.cfg.data.data_prefix.get('validation') != None, f"Data prefix dictionary should have train, test and validation keys.  data_prefix currently has only {self.cfg.data.data_prefix.keys()}"
            self.log(self.cfg.data.splits_string  + "ignored since data prefix is of type dictionary")
