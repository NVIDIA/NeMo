...
#     """The name of logged metric which is used for updating learning rate if "reduce on plateau" learning rate
#     scheduling is used."""
#
#     reduce_on_plateau: bool = False
#     """Whether to use 'reduce on plateau' learning strategy."""
#
#
