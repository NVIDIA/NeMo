...
class TextClassificationModel(NLPModel, Exportable):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        # register the file containing the labels into the artifacts to get saved in the '.nemo' file
        if 'class_labels' in cfg and 'class_labels_file' in cfg.class_labels and cfg.class_labels.class_labels_file:
            self.register_artifact('label_ids.csv', cfg.class_labels.class_labels_file)
