...
class BatchedBeamHyps:
    ...
    def __init__(
        ...
        self.hyps_beam = hyps_beam
        self.time_beam = time_beam
...
class GreedyBatchedRNNTLoopLabelsComputer(ConfidenceMethodMixin):
    ...
    def __call__(
        ...
        return self.loop_labels_beam_torch(encoder_output=x, encoder_output_length=out_len)
