...
class GreedyRNNTInfer(_GreedyRNNTInfer):
    ...
    def _greedy_decode(
        ...
        if partial_hypotheses is not None:
            ...
            hypothesis.y_sequence = partial_hypotheses.y_sequence.cpu().tolist() if isinstance(partial_hypotheses.y_sequence, torch.Tensor) else partial_hypotheses.y_sequence
