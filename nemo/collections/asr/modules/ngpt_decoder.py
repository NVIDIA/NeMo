...
class NGPTDecoder(nn.Module):
    ...
    def forward(self, decoder_state, decoder_mask, encoder_state,encoder_mask):
        # Decoder
        for decoder_block in self.decoder_blocks:
            decoder_state = decoder_block(decoder_state, decoder_mask, encoder_state,encoder_mask)
