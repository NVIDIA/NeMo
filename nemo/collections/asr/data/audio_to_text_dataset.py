...
def get_concat_char_dataset(
    ...
    dataset = ConcatDataset(
        ...
        concat_samples=config.get('concat_samples', False),
        concat_samples_count_as_one=config.get('concat_samples_count_as_one', True),
        concat_samples_max_length=config.get('concat_samples_max_length', 20),
        concat_samples_min_length=config.get('concat_samples_min_length', 16),
        concat_samples_joining_pause=config.get('concat_samples_joining_pause', 0.1),
        concat_samples_normalize_db=config.get('concat_samples_normalize_db', None),
