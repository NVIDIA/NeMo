...
class LhotseSpeechToTextBpeDatasetTgtLangID(torch.utils.data.Dataset):
    ...
    def lang_to_target_lang(
        self, cut, num_languages: int, num_sample_per_mel_frame: int, num_mel_frame_per_asr_frame: int
    ):
        """
        ...
        encoder_hidden_len = self.get_hidden_length_from_sample_length(
            cut.num_samples, num_sample_per_mel_frame, num_mel_frame_per_asr_frame
        )
    ...
    def get_hidden_length_from_sample_length(
        self, num_samples: int, num_sample_per_mel_frame: int = 160, num_mel_frame_per_asr_frame: int = 8
    ) -> int:
        """
