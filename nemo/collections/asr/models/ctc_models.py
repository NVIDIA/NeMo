...
from nemo.collections.asr.parts.mixins import ASRModuleMixin, CTCDistillationMixin
...
class EncDecCTCModel(ASRModel, ExportableEncDecModel, ASRModuleMixin, CTCDistillationMixin):
