...
class EncDecRNNTBPEModel(EncDecRNNTModel, ASRBPEMixin):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        logging.info("setting dist_sync_on_step to False from bpe 1")
        # Setup wer object
        self.wer = WER(
    ...
    def change_vocabulary(
        ...
        logging.info("setting dist_sync_on_step to False from bpe 2")
        self.wer = WER(
            decoding=self.decoding,
    ...
    def change_decoding_strategy(self, decoding_cfg: DictConfig, verbose: bool = True):
        ...
        logging.info("setting dist_sync_on_step to False from bpe 3")
        self.wer = WER(
            decoding=self.decoding,
            batch_dim_index=self.wer.batch_dim_index,
            use_cer=self.wer.use_cer,
