...
class EncDecRNNTBPEModel(EncDecRNNTModel, ASRBPEMixin):
    ...
    def list_available_models(cls) -> List[PretrainedModelInfo]:
        ...
        model = PretrainedModelInfo(
            ...
            description="For details about this model, please visit https://ngc.nvidia.com/catalog/modelswget 'https://api.ngc.nvidia.com/v2/models/nvidia/nemo/stt_fr_conformer_transducer_large/versions/1.5/files/stt_fr_conformer_transducer_large.nemo'/nvidia:nemo:stt_fr_conformer_transducer_large",
