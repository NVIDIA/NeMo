...
from nemo.lightning import io, get_vocab_size, OptimizerModule, MegatronOptimizerModule
...
class CLIPViTModel(MCoreCLIPViTModel):
    def __init__(self,
        ...
        super().__init__(transformer_config = transformer_config,
                 transformer_layer_spec = transformer_layer_spec,
...
class MCoreClipModel(MegatronModule):
    ...
    def __init__(self,
        ...
        self.text_model = text_transformer_config.configure_model(tokenizer=tokenizer,
                                                                      pre_process=pre_process,
                                                                      post_process=post_process)
