...
class Conversation:
    ...
    def process_chat_template(self, tokenizer_name_or_path, messages):
        ...
        if self.override_chat_template is not None:
            tokenizer.chat_template = self.override_chat_template
...
conv_llama_nemotron_vl = Conversation(
    system=None,
    roles=("user", "assistant"),
    version="llama_v3",
    messages=[],
...
conv_templates = {
    ...
    "nv_dpo": conv_nv_dpo,
    "llama_nemotron_vl": conv_llama_nemotron_vl,
}
