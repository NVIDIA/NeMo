...
from nemo.collections.vlm.openvla.data.prismatic.vla.datasets.rlds.oxe import (
    OXE_NAMED_MIXTURES,
...
class RLDSBatchTransform:
    ...
    def __call__(self, rlds_batch: Dict[str, Any]) -> Dict[str, Any]:
        ...
        print(f"dataset_name[Rank: {rank} Datarank: {data_rank}]: {dataset_name}, action: {action}, lang: {lang}")
        ...
        # print(f"pixed value std: {pixel_values.std()}, mean: {pixel_values.mean()}")
