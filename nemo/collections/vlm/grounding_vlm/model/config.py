...
# your own needs
@dataclass
class Qwen2VLGroundingConfig2B(Qwen2VLGroundingConfig):
    """Qwen2VL Config 2B"""
...
@dataclass
class Qwen2VLGroundingConfig7B(Qwen2VLGroundingConfig):
    """Qwen2VL Config 7B"""
...
@dataclass
class Qwen2VLGroundingConfig72B(Qwen2VLGroundingConfig):
    """Qwen2VL Config 72B"""
...
@dataclass
class Qwen25VLGroundingConfig3B(Qwen2VLGroundingConfig):
    """Qwen2.5VL Config 3B"""
...
@dataclass
class Qwen25VLGroundingConfig7B(Qwen2VLGroundingConfig):
    """Qwen2.5VL Config 7B"""
...
@dataclass
class Qwen25VLGroundingConfig32B(Qwen2VLGroundingConfig):
...
@dataclass
class Qwen25VLGroundingConfig72B(Qwen2VLGroundingConfig):
...
@io.model_importer(Qwen2GroundingVLModel, "hf")
class HFQwen2VLGroundingImporter(io.ModelConnector["Qwen2VLForConditionalGeneration", Qwen2GroundingVLModel]):
    """Qwen2VL Model HF Importer"""

    def init(self) -> Qwen2GroundingVLModel:
        # pylint: disable=C0115,C0116
        return Qwen2GroundingVLModel(self.config, model_version="qwen2-vl", tokenizer=self.tokenizer)
    ...
    @property
    def config(self) -> Qwen2VLGroundingConfig:
        # pylint: disable=C0115,C0116
...
@io.model_exporter(Qwen2GroundingVLModel, "hf")
class HFQwen2VLExporter(io.ModelConnector[Qwen2GroundingVLModel, "Qwen2VLForConditionalGeneration"]):
    """
