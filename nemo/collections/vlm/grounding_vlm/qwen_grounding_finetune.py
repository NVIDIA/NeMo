...
Example:
  ...
  --language_model_path=/root/.cache/nemo/models/Qwen/Qwen2.5-VL-3B-Instruct
"""
...
def main(args):
    ...
    if args.data_type == "energon":
        ...
        data = gvlm.data.ClassificationDetectionMockDataModule(
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Qwen2VL Grounding Finetuning Script")
