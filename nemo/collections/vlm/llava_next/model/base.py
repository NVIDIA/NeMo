...
class LlavaNextConfig(NevaConfig):
    ...
    def configure_model(self, tokenizer) -> "MCoreLlavaNextModel":
        ...
        self.language_transformer_config.use_cpu_initialization = self.use_cpu_initialization
        self.vision_transformer_config.use_cpu_initialization = self.use_cpu_initialization
        self.vision_projection_config.use_cpu_initialization = self.use_cpu_initialization
