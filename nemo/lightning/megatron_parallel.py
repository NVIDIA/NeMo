...
def extract_ddp_funcs(ddp_config, pipeline):
    no_sync_func, grad_sync_func, param_sync_func = None, None, None
    ...
    # if getattr(ddp_config, "overlap_param_sync", False) and getattr(ddp_config, "delay_param_gather", False):
    #     param_sync_func = [
    ...
    return no_sync_func, grad_sync_func, param_sync_func
...
class MegatronParallel(nn.ModuleList, Generic[ModelT]):
    ...
    def __init__(
        ...
        if isinstance(ddp_config, DistributedDataParallelConfig):
            ...
            no_sync_func, grad_sync_func, param_sync_func = extract_ddp_funcs(ddp_config, _pipeline)
