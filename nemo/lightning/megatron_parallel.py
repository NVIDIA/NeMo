    ...
    def wrapped_forward_step(
        ...
        def wrapped_forward_step_func(dataloader_iter, model):
            ...
            if self.precision_plugin and parallel_state.is_pipeline_first_stage(
                ignore_virtual=False, vp_stage=getattr(model.module.module, "vp_stage", None) if isinstance(model.module, FullyShardedDataParallel) else getattr(model.module, "vp_stage", None)
            ):
