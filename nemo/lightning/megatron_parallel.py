...
class MegatronParallel(nn.ModuleList, Generic[ModelT]):
    ...
    ----------
        ...
        enable_whole_network_cuda_graph (bool): Whether Full iteration (FWD+BWD) CUDAgraph should be enabled.
...
class MegatronStep(Generic[ModelT, DataT]):
    ...
    def infer(
        ...
        return cls(
            ...
            step_i=step_i,
            enable_whole_network_cuda_graph=enable_whole_network_cuda_graph,
        )
    ...
    def forward_backward_func(self) -> "MegatronStepProtocol":
        ...
        if self.enable_whole_network_cuda_graph:
