...
def init_model_parallel(model: Optional[nn.Module] = None) -> None:
    ...
    if app_state.model_parallel_size is not None:
        ...
        if torch.distributed.is_initialized():
            ...
            assert app_state.expert_tensor_parallel_rank == parallel_state.get_expert_tensor_parallel_rank(), (app_state.expert_tensor_parallel_rank, parallel_state.get_expert_tensor_parallel_rank())
