                    ...
                    while True:
                        ...
                        if self._grad_scale_ar_fusion:
                            torch.distributed.all_reduce(
                                ...
                                async_op=True,
                                op=torch.distributed.make_nccl_premul_sum(self._grad_scale),
                            )
                        else:
