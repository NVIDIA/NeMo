...
from ..model_config import DECODER_GPT2, DECODER_GPTJ, DECODER_GPTNEXT, DECODER_LLAMA, QUANTIZATION_NONE
...
def build_decoder_layer_config(layer, decoder: str, dtype=trt.float16, rank=0, tensor_parallel=1):
    ...
    return DECODER_CONFIG_REGISTRY[decoder](decoder, dtype, rank, tensor_parallel).build_layer(layer)  # type: ignore
...
def build_decoder_layer(
    ...
    return DECODER_REGISTRY[layer.decoder_type](layer, num_layers, dtype, quantization, rank, tensor_parallel)
