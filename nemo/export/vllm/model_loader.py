...
import torch
import zarr
from vllm.config import CacheConfig, DeviceConfig, LoRAConfig, ParallelConfig, SchedulerConfig, MultiModalConfig
        ...
        with set_default_torch_dtype(model_config.dtype):
            with torch.device(device_config.device):
                model = _initialize_model(
                    model_config, self.load_config, lora_config, multimodal_config, cache_config
                )
