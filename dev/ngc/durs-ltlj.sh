...
# [1GPU,16G] Biggest bs is _. One epoch is around _ iterations. Total number of steps is _.
# [1GPU,32G] Biggest bs is _. One epoch is around _ iterations. Total number of steps is _.
# [8GPU,32G] Biggest bs is 64. One epoch is around _ iterations. Total number of steps is _.
batch_size=$((GPU_MEM * 2))
