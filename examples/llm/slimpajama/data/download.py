...
def download_slimpajama(include_pattern: str = "", exclude_pattern: str = ""):
    hf_cli_cmd = "huggingface-cli download cerebras/SlimPajama-627B {include_pattern} {exclude_pattern} --quiet --repo-type dataset --local-dir /data/slimpajama --cache-dir /data/slimpajama"
