...
def main(cfg):
    ...
    with open_dict(cfg.model.speaker_encoder):
        add_weight_speaker_list = cfg.model.speaker_encoder.pop("add_weight_speaker_list", None)
        add_weight_speaker = cfg.model.speaker_encoder.pop("add_weight_speaker", False)
