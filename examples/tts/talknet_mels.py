...
class TalkNetGraph:
    def __init__(self, args, engine, config):
        ...
        self.eval_dls = {}
        for name, eval_dataset, eval_durs1 in itertools.zip_longest(
            args.eval_names, args.eval_datasets, args.eval_durs, fillvalue=None,
        ):
        ...
        self.loss = nemo_tts.TalkNetMelsLoss(**config.TalkNetMelsLoss)
