...
from nemo.collections.asr_tts.tts_rnnt_model import TextToSpeechTransducerModel
...
@hydra_runner(config_path="../tts/conf", config_name="conformer_transducer_bpe_as_asr")
def main(cfg):
    ...
    print("===1111")
    asr_model = TextToSpeechTransducerModel(cfg=cfg.model, trainer=trainer)
    print("===2222")
