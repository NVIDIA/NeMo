...
def main(cfg) -> None:
    ...
    assert (cfg.trainer.devices * cfg.trainer.num_nodes) * cfg.model.micro_batch_size == \
           cfg.model.global_batch_size, "Gradient accumulation is not supported in CLIP yet."
