...
class MultimodalModelRunner:
    ...
    def __init__(self, cfg):
        ...
        with open(os.path.join(self.cfg.visual_engine_dir, "config.json"),
                  "r") as f:
            config = json.load(f)
    ...
    def init_tokenizer(self):
        ...
        sp = SentencePieceProcessor(
            os.path.join(self.cfg.llm_engine_dir, 'tokenizer.model'))
    ...
    def init_image_encoder(self):
        vision_encoder_path = os.path.join(self.cfg.visual_engine_dir,
    ...
    def init_llm(self):
        self.model = ModelRunner.from_dir(self.cfg.llm_engine_dir,
    ...
    def preprocess(self, warmup, pre_prompt, post_prompt, image,
        ...
        input_lengths = torch.IntTensor([length] * self.cfg.batch_size).to(
            torch.int32)
    ...
    def setup_inputs(self, input_text, raw_image):
        ...
        if image.dim() == 5:
            image = image.expand(self.cfg.batch_size, -1, -1, -1,
                                    -1).contiguous()
        else:
