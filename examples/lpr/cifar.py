...
classifier = neural_factory.get_module(name="SimpleCNNClassifier", collection="nemo_lpr",
                                       params={})

loss = neural_factory.get_module(name="CrossEntropyLoss", collection="toys",
...
callback_eval = nemo.core.EvaluatorCallback(eval_tensors=[e_loss, e_pred, e_label],
...
optimizer.train(tensors_to_optimize=[t_loss],
                tensors_to_evaluate=[t_pred, t_label],
