...
from nemo.collections.nlp.modules.common.transformer.text_generation import SamplingParam, LengthParam
...
{input}<|eot_id|><|start_header_id|>assistant<|end_header_id|>"""
    ...
    sampling_params = SamplingParam(temperature=1.0, use_greedy=True, top_k=1, top_p=1.0, repetition_penalty=1.0,
                                    add_BOS=False, all_probs=False, compute_logprob=False,
