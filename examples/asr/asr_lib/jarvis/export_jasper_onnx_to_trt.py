...
def get_parser():
    ...
    parser.add_argument(
        "onnx", default=None, type=str,
        help="Path to Jasper ONNX model")
    parser.add_argument(
        "trt_plan", default=None, type=str,
        help="Path to output Jasper TRT model plan")
    parser.add_argument(
    ...
    parser.add_argument(
        "--max-workspace-size", type=int, default=128, 
        help="Max WS size, in MB")
...
if __name__ == '__main__':
    ...
    engine = build_engine(args.onnx, seq_len=args.seq_len,
