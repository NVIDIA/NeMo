...
python speech_to_text_bpe_transcribe.py \
    model_path=null \
...
@dataclass
class SpeechToTextBPETranscribeConfig:
    model_path: Optional[str] = None
    pretrained_name: Optional[str] = None
    audio_dir: str = MISSING
    output_filename: str = "speech_to_text_bpe_transcriptions.txt"
    batch_size: int = 32
    cuda: Optional[bool] = None
    audio_type: str = "wav"


@hydra_runner(config_name="SpeechToTextBPETranscribeConfig", schema=SpeechToTextBPETranscribeConfig)
def main(cfg: SpeechToTextBPETranscribeConfig):
