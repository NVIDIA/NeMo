...
parser.add_argument()
parser.add_argument("--local_rank", default=os.getenv('LOCAL_RANK', None), required=True, type=int, help="node rank for distributed training")
parser.add_argument("--amp_opt_level", default="O0", type=str, choices=["O0", "O1", "O2", "O3"], help="See: https://nvidia.github.io/apex/amp.html")
parser.add_argument("--asr_model", type=str, default="QuartzNet15x5-En-BASE", required=True,
...
def main():
    ...
    train_data_layer = nemo_asr.AudioToTextDataLayer(manifest_filepath=args.train_dataset,
