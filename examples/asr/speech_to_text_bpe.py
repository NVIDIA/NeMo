...
def restore_weights_if_required(model: EncDecCTCModelBPE, cfg: OmegaConf):
    ...
    if 'init_from_nemo_model' in cfg and cfg.init_from_nemo_model is not None:
        with open_dict(cfg):
            ...
            restored_model = EncDecCTCModelBPE.restore_from(model_path, map_location='cpu', strict=True)
    ...
    if 'init_from_pretrained_model' in cfg and cfg.init_from_pretrained_model is not None:
        with open_dict(cfg):
            ...
            restored_model = EncDecCTCModelBPE.from_pretrained(model_name, map_location='cpu', strict=True)
