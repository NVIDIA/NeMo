...
data_layer = nemo_asr.AudioToTextDataLayer.import_from_config(model_config_file,
    "AudioToTextDataLayer_train", overwrite_params={"manifest_filepath": train_manifest, "batch_size": 16})
...
# with CompositeNeuralModule(modules=[data_preprocessor, jasper_encoder, jasper_decoder]) as cm:
