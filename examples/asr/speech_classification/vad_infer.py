...
Usage:
python vad_infer.py --config-path="conf" --config-name="vad_inference_postprocessing.yaml" dataset=<Path of json file of evaluation data. Audio files should have unique names>
...
@hydra_runner(config_path="conf", config_name="vad_inference_postprocessing.yaml")
def main(cfg):
    if not cfg.dataset:
