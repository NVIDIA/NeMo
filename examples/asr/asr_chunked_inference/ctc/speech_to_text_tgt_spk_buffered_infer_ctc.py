...
python speech_to_text_tgt_spk_buffered_infer_ctc.py \
    model_path=null \
...
def main(cfg: TranscriptionConfig) -> TranscriptionConfig:
    ...
    if cfg.batch_view == "sample":
        # one sample's multiple chunks are processed in one batch, use this option when dataset average duration is long
