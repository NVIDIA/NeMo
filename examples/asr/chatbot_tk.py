...
if not os.path.isfile(data_file):
    with gzip.open("/home/tkornuta/workspace/nemo/tests/data/movie_lines.txt.gz", 'rb') as f_in:
        with open(data_file, 'wb') as f_out:
            shutil.copyfileobj(f_in, f_out)
#data_file = "/home/tkornuta/data/cornell movie-dialogs corpus/movie_lines.txt"
