...
polygraphy surgeon extract encoder-temp_rnnt.onnx --inputs audio_signal:auto:auto length:auto:auto --outputs /layers.0/norm_out/LayerNormalization_output_0:auto -o encoder_subgraph.onnx
