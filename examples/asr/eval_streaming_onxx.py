# TODO: drop this file, not to be added to main
...
processed_signal, processed_signal_length, cache_last_channel, cache_last_time = asr_model.encoder.input_example(
    max_batch=1, max_dim=4096
)
