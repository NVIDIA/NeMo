...
# Training the model
```sh
python speech_to_text_hybrid_aed.py \
...
from nemo.collections.asr.models import EncDecHybridMultiTaskCTCModel
...
def main(cfg):
    ...
    aed_model = EncDecHybridMultiTaskCTCModel(cfg=cfg.model, trainer=trainer)
