...
def compute_rates(input_manifest_path: str, punctuation_marks: list[str],
                  reference_field: str = "text", hypothesis_field: str = "pred_text",
                  punctuation_mask: str = "[PUNCT]", output_manifest_path: str = None):
    ...
    per_data = PERData(references = references, hypotheses=hypotheses,
                       punctuation_marks = punctuation_marks, punctuation_mask = punctuation_mask)
...
if __name__ == "__main__":
    ...
    compute_rates(input_manifest_path=args.manifest,
