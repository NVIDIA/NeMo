...
def get_command_for_inference(inference_config, inference_config_dir, p_cache, checkpoint):
...
def get_execution_script(cluster_script_path, config_name, config_path):
