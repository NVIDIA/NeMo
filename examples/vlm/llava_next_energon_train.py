...
def main(args) -> None:
    ...
    if args.load_from_hf:
        ...
        model = fabric.import_model("hf://llava-hf/llava-v1.6-mistral-7b-hf", LlavaModel)
        #
    else:
    ...
    media = one_batch["media"]
    input_ids = one_batch["tokens"]
    position_ids = one_batch["position_ids"]
