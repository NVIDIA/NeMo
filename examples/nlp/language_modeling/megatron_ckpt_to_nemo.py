...
def get_args():
    ...
    parser.add_argument(
        "--model_type", type=str, required=True, default="gpt", choices=["gpt", "sft", "t5", "bert", "nmt", "bart", "retro"]
    )
...
def convert(local_rank, rank, world_size, args):
    ...
    if args.model_type == 'gpt':
        ...
        model = MegatronGPTSFTModel.load_from_checkpoint(checkpoint_path, hparams_file=args.hparams_file, trainer=trainer)
