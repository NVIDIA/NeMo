...
def main(cfg) -> None:
    ...
    if cfg.gpt_model_file:
        ...
        if (
            ...
            or cfg.expert_model_parallel_size > 1
        ):
            app_state.model_parallel_size = (
                cfg.tensor_model_parallel_size * cfg.pipeline_model_parallel_size * cfg.expert_model_parallel_size
            )
            app_state.tensor_model_parallel_size = cfg.tensor_model_parallel_size
            app_state.pipeline_model_parallel_size = cfg.pipeline_model_parallel_size
            app_state.expert_model_parallel_size = cfg.expert_model_parallel_size
            (
