...
"""
This is the script to Synthetic Dataset evaluation with base GPT models (FA is enabled).

Usage:
    python ${NEMO_DIR}/examples/nlp/language_modeling/megatron_gpt_eval_synthetic.py \
        ...
        inference.input_file=${DATASET}.jsonl \
...
@hydra_runner(config_path='conf', config_name='megatron_gpt_inference_synthetic')
def main(cfg) -> None:
    ...
    #                     cur_line['pred'] = s[len(truncated_input[idx]):]
