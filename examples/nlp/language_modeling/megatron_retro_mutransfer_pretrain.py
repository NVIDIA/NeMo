...
from nemo.collections.nlp.parts.megatron_trainer_builder import MegatronNoDistAdamTrainerBuilder
...
def main(cfg) -> None:
    ...
    trainer = MegatronNoDistAdamTrainerBuilder(cfg).create_trainer()
