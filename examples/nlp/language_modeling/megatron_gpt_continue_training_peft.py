...
from nemo.collections.nlp.models.language_modeling.megatron_gpt_model_peft import MegatronGPTModel
...
@hydra_runner(config_path="conf", config_name="megatron_gpt_finetuning_ct_config")
def main(cfg) -> None:
    ...
    if cfg.model.peft.restore_from_path is not None:
        ...
        model.load_adapters(cfg.model.peft.restore_from_path, peft_cfg_cls(cfg.model))
