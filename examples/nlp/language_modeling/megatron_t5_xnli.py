...
def main(cfg) -> None:
    ...
    t5_cfg = MegatronT5XNLIModel.restore_from(restore_path=cfg.model.restore_from_path, trainer=trainer, return_config=True)
    ...
    model = MegatronT5XNLIModel.restore_from(restore_path=cfg.model.restore_from_path, trainer=trainer, override_config_path=t5_cfg)
