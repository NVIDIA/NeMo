...
def main(cfg) -> None:
    ...
    model_cfg = MegatronGPTModel.restore_from(
        cfg.model.restore_path, trainer=trainer, save_restore_connector=NLPSaveRestoreConnector(),
        return_config=True
    )

    # modify config
    base_model_cfg = _modify_config(model_cfg, cfg, add_cfg_to_tree=False)
