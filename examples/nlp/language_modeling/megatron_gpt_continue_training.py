...
def _modify_config(gpt_cfg, cfg, add_cfg_to_tree=False):
    ...
    with open_dict(gpt_cfg):
        ...
        assert gpt_cfg.encoder_seq_length = gpt_cfg.max_position_embeddings * gpt_cfg.seq_len_interpolation_factor, 'seq_length should be equal to max_position_embedding * seq_len_interpolation_factor'
