...
from nemo.collections.nlp.models.language_modeling.megatron_griffin_sft_model import \
    MegatronGriffinSFTModel
...
def main(cfg) -> None:
    ...
    if cfg.model.peft.restore_from_path:
        model_cfg = MegatronGriffinSFTModel.merge_inference_cfg(
    ...
    model = MegatronGriffinSFTModel.restore_from(
