...
def main(cfg) -> None:
    ...
    #     model_cfg = MegatronJambaSFTModel.merge_inference_cfg(cfg.model.peft.restore_from_path, cfg)
    # else:
    model_cfg = MegatronJambaSFTModel.merge_inference_cfg(cfg.model.restore_from_path, cfg)
