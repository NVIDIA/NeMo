...
parser.add_argument("--fully_connected_dropout", default=0.0, type=float)
...
parser.add_argument("--dataset_dir", default="../../tests/data/wikitext-2/", type=str)
...
parser.add_argument("--eval_dataset", default="small_test", type=str)
...
eval_dataset = args.dataset_dir + args.eval_dataset + ".txt"
...
# evaluation pipeline with greedy language generator on top of the model output
...
generated_text = language_generator(input_ids=src_)
...
callback_dev = nemo.core.EvaluatorCallback(
    eval_tensors=[eval_loss, generated_text],
