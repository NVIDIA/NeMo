...
parser = argparse.ArgumentParser(
    description='Chinese news classification with pretrained BERT')
...
parser.add_argument("--pretrained_bert_model",
                    ...
                    type=str)
parser.add_argument("--data_dir", default='data/sc/THUCNews', type=str)
parser.add_argument("--dataset_name", default='thucnews', type=str)
