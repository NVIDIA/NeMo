...
def _write_batches_to_tarfiles(
    ...
    dataset = TextNormalizationDecoderDataset(
        ...
        raw_instances=_preprocess_file(input_file=input_file, lang=lang),
        tokenizer=tokenizer,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--transformer_name', type=str, default="t5-base", help='Name of the pretrained LM.')
    ...
    parser.add_argument('--lang', default='en', type=str, help='Data language.')
    parser.add_argument(
        '-in', '--input_files', action='append', required=True, help="Example: -in 'fname1.txt' --in 'fname2.txt'",
    )
