...
parser.add_argument('--output_dir', type=str, help='Path to output directory. If not specified, generate the dialogues in the same directory as the script.')
parser.add_argument('--annotate_copy_slots', action='store_true', help='Whether to annotate slots whose value is copied from a different slot in '
...
_PATH_MAPPING = [('test', 'testListFile.json'), ('dev', 'valListFile.json'),
                 ('train', '')]
