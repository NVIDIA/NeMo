...
def main():
    ...
    parser.add_argument(
        ...
        "no set, then target language processing will be done the same way as during model training. If "
    ...
    parser.add_argument(
        ...
        "no set, then source language processing will be done the same way as during model training. If "
