...
from nemo.collections.nlp.models.machine_translation.mt_enc_dec_retrieval_model import MTRetrievalModel
...
class MTRetrievalConfig(NemoConfig):
    ...
    model: MTRetrievalModelConfig = MTRetrievalModelConfig()
    trainer: Optional[TrainerConfig] = TrainerConfig()
    exp_manager: Optional[ExpManagerConfig] = ExpManagerConfig(name='MTRetrieval', files_to_copy=[])


@hydra_runner(config_path="conf", config_name="aayn_retrieval")
def main(cfg: MTRetrievalConfig) -> None:
    # merge default config with user specified config
    default_cfg = MTRetrievalConfig()
    ...
    mt_model = MTRetrievalModel(cfg.model, trainer=trainer)
