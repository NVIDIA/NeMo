...
def main(cfg: DictConfig) -> None:
    ...
    pretrained_ner_model = TokenClassificationModel.restore_from('/home/ebakhturina/nemo_ckpts/ner_gmb_clean/ptl_ner_with_nemo_bert_ckpt/1351452/ner.nemo')
    pretrained_ner_model.update_data_dir('/home/ebakhturina/data/ner/conell/sample')
