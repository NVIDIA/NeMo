...
- Created CV collection, added  MNIST and CIFAR10 thin datalayers, implemented/ported several general usage trainable and non-trainable modules ([PR #654](https://github.com/NVIDIA/NeMo/pull/654)) - @tkornuta-nvidia
