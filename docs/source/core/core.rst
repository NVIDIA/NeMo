...
run the training/inference script from the command-line (see `here <https://github.com/NVIDIA/NeMo/blob/4e9da75f021fe23c9f49404cd2e7da4597cb5879/examples/asr/ASR_CTC/speech_to_text.py#L24>`_
for an example).
...
.. code-block:: bash
    ...
    python examples/asr/ASR_CTC/speech_to_text.py \
