...
Initialization
--------------
.. constructor:: HFAutoModelForSpeechSeq2Seq(*, model_name='gpt2', load_pretrained_weights=True, tokenizer=None, loss_fn=masked_cross_entropy, model_transform=None, te_config=None, trust_remote_code=False)
