...
Constructor
-----------
.. constructor:: HFAutoModelForCausalLM(*, model_name='gpt2', load_pretrained_weights=True, tokenizer=None, loss_fn=masked_cross_entropy, model_transform=None, te_config=None, trust_remote_code=False, default_dtype=torch.bfloat16, load_in_4bit=False, attn_implementation="sdpa")
    ...
    te_config : TEConfig or `None`
        Config for applying TransfomerEngine to model, mainly for FP8 Autocasting.
