...
The term "SpeechLLM" refers to the endeavor to extend Language Models (LLMs) with the ability to understand speech and audio inputs. More detailed information can be found in the `SpeechLLM examples README <https://github.com/NVIDIA/NeMo/blob/main/examples/multimodal/speech_llm/README.md>`_.
