...
``INPUT_CASE`` specifies whether to treat the input as lower-cased or case sensitive. Punctuation are outputted with separating spaces after semiotic tokens, e.g. `"I see, it is 10:00..."` -> `"I see, it is ten o'clock  .  .  ."`.
