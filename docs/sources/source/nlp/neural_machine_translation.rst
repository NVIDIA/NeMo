...
We use newstest2013 for development and newstest2014 for testing. All datasets, as well as the tokenizer model can be downloaded from `here <https://ngc.nvidia.com/catalog/models/nvidia:transformer_big_en_de_8k>`_. In the following steps, we assume that all data is located at **<path_to_data>**.
