...
.. note:: This documentaion corresponds to NeMo version 0.8. Once you have all requirements satisfied (see below), you can either install this version using pip: ``pip install nemo_toolkit && pip install nemo_asr && pip install nemo_nlp`` or use **r0.8** branch from GitHub.
