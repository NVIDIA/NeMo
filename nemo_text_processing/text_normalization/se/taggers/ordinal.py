...
class OrdinalFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, deterministic: bool = True):
        ...
        acc_sg = pynini.string_map([
            ("t", "da"),
            ("š", "ža"),
            ("bbi", "ppi")
        ])
        gen_sg = pynini.string_map([
            ("t", "da"),
            ("š", "ža"),
            ("bbi", "ppi")
        ])
        ill_sg = pynini.string_map([
            ("t", "dii"),
            ("š", "žii"),
            ("bbi", "bbái")
        ])
        loc_sg = pynini.string_map([
            ("t", "dis"),
            ("š", "žis"),
            ("bbi", "ppis")
        ])
        com_sg = pynini.string_map([
            ("t", "diin"),
            ("š", "žiin"),
            ("bbi", "ppiin")
        ])
        ess_sg = pynini.string_map([
            ("t", "din"),
            ("š", "žin"),
            ("bbi", "bbin")
        ])
        nom_pl = pynini.string_map([
            ("t", "dat"),
            ("š", "žat"),
            ("bbi", "ppit")
        ])
        acc_pl = pynini.string_map([
            ("t", "diid"),
            ("š", "žiid"),
            ("bbi", "ppiid")
        ])
        gen_pl = pynini.string_map([
            ("t", "diid"),
            ("š", "žiid"),
            ("bbi", "ppiid")
        ])
        ill_pl = pynini.string_map([
            ("t", "diidda"),
            ("š", "žiidda"),
            ("bbi", "ppiide")
        ])
        loc_pl = pynini.string_map([
            ("t", "diin"),
            ("š", "žiin"),
            ("bbi", "ppiin")
        ])
        com_pl = pynini.string_map([
            ("t", "diiguin"),
            ("š", "žiiguin"),
            ("bbi", "ppiiguin")
        ])
