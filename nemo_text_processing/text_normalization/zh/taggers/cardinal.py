...
class Cardinal(GraphFst):
    '''
        self.graph_cardinal:
        5       -> cardinal{ integer: "五"}
        12      -> cardinal{ integer: "十二"}
        213     -> cardinal{ integer: "二百一十三"}
        3123    -> cardinal{ integer: "三千一百二十三"}
        3,123   -> cardinal{ integer: "三千一百二十三"}
        51234   -> cardinal{ integer: "五万一千二百三十四"}
        51,234  -> cardinal{ integer: "五万一千二百三十四"}
        0.125   -> cardinal{ integer: "零点一二五"}
        self.fst:
    ...
    def __init__(self, deterministic: bool = True, lm: bool = False):
        ...
        graph_teen = pynini.string_file(get_abs_path("data/cardinal/digit_teen.tsv"))
        graph_sign = pynini.string_file(get_abs_path("data/cardinal/sign.tsv"))
