...
import pynini
from nemo_text_processing.text_normalization.zh.graph_utils import NEMO_NOT_QUOTE, NEMO_SIGMA, GraphFst, delete_space
...
class Date(GraphFst):
    ...
    def __init__(self, deterministic: bool = True, lm: bool = False):
        ...
        graph_ten = pynini.string_file(get_abs_path("data/cardinal/digit_teen.tsv"))
        ...
        graph_2_digit_date = (graph_ten + pynutil.insert(UNIT_1e01) + graph_digit_no_zero) | (
