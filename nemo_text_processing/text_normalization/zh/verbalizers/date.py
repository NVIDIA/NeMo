import pynini
from nemo_text_processing.text_normalization.zh.graph_utils import NEMO_SIGMA, NEMO_NOT_QUOTE ,GraphFst,delete_space
...
class Date(GraphFst):
    ...
    def __init__(self, deterministic: bool = True, lm: bool = False):
        ...
        date_type1 = pynutil.delete("year: \"") + graph_year + pynutil.insert("年") + pynutil.delete("\"") + delete_space\
                    + pynutil.delete("month: \"") + graph_2_digit_date + pynutil.insert("月") + pynutil.delete("\"") + delete_space\
                    + pynutil.delete("day: \"") + graph_2_digit_date + pynutil.insert("日") + pynutil.delete("\"")

        date_type2 = pynutil.delete("year: \"") + graph_year + pynutil.insert("年") + pynutil.delete("\"") + delete_space\
