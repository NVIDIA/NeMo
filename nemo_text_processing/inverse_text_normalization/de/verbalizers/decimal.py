...
class DecimalFst(GraphFst):
    ...
    def __init__(self, tn_decimal_verbalizer: GraphFst):
        ...
        optional_fractional = pynini.closure(delete_space + pynutil.insert(",") + tn_decimal_verbalizer.fractional_default, 0, 1)
