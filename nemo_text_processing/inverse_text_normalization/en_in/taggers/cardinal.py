...
from nemo_text_processing.inverse_text_normalization.en_in.utils import get_abs_path, num_to_word
...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        graph = pynini.union((graph_int | graph_ind) + delete_space + graph_hundred_component, graph_zero,)
