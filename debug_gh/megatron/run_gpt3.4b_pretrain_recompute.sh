...
2>&1 | tee gh_gpt_3.4b_recompute_MBS_${MICRO_BATCH_SIZE}_seq_${SEQ_LENGTH}_amp_O2_${MEGATRON_AMP_O2}_granularity_${CHECKPOINT_GRANULARITY}_method_${CHECKPOINT_METHOD}_num_layers_${CHECKPOINT_NUM_LAYERS}.log