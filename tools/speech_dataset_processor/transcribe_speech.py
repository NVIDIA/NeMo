# TODO: this file is copied from NeMo code. We should remove it when everything
#    is integrated into NeMo. Alternatively, we can change things on the NeMo
#    side to provide installation of such scripts via pip (e.g., nemo-tools)
#    package, which will allow usage of this functionality without getting
#    the source code (which might be useful on it's own).
