...
_TRANSLATETEXTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='texts', full_name='nvidia.riva.nmt.TranslateTextRequest.texts', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='source_language', full_name='nvidia.riva.nmt.TranslateTextRequest.source_language', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='target_language', full_name='nvidia.riva.nmt.TranslateTextRequest.target_language', index=2,
...
_TRANSLATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='translation', full_name='nvidia.riva.nmt.Translation.translation', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='language', full_name='nvidia.riva.nmt.Translation.language', index=1,
...
_TRANSLATETEXTRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='translations', full_name='nvidia.riva.nmt.TranslateTextResponse.translations', index=0,
