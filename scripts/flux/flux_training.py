...
def unit_test(custom_fsdp=True) -> run.Partial:
    ...
    recipe.model.flux_params.device = 'cuda'
    recipe.model.flux_params.flux_config = run.Config(FluxConfig, num_joint_layers=1, num_single_layers=1, calculate_per_token_loss=False, gradient_accumulation_fusion=False)
