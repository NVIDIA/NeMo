#!/bin/bash
#SBATCH -A coreai_dlalgo_llm             # slurm account
#SBATCH -p batch                           # slurm partition
#SBATCH -J coreai_dlalgo_llm-clip_pretrain.energon_new # job name with num_workers
...
TRAIN_DATA="${DATA_DIR}/coyo-700m-reshared"
...
NAME="clip_pretrain_launcher_config_8_8_newer_energon_4hr_reshared_${NUM_WORKERS}"
...
PIP_INSTALL_CMD="pip install --no-cache-dir -U 'megatron-energon @ git+https://github.com/NVIDIA/Megatron-Energon.git@920bb6b430f115fc0d9e75900bd39bfb21335ed9'"
