...
def main(args):
    ...
    model = CLIPModel(ClipConfigB32(), tokenizer=train_task_encoder.tokenizer,
                      imagenet_val=args.imagenet_val,
                      mbs=args.mbs,
                      gbs=args.gbs, max_workers=8)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str,
                        required=False, default=None, help="Path to the dataset director")
    ...
    parser.add_argument("--decoder_seq_length", type=int, required=False, default=80, help="Decoder"
                                                                                           " sequence length for encoding the input text")
    ...
    parser.add_argument("--imagenet_val", type=str, required=False,
                        default=None, help="imagenet path for val")
