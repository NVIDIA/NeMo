...
def main(args):
    ...
    avlm_config = vlm.AVLMConfig(
        language_transformer_config=language_transformer_config,
        vision_transformer_config=vision_transformer_config,
        vision_projection_config=vision_projection_config,
        speech_transformer_config=speech_transformer_config,
        speech_projection_config=speech_projection_config,
        language_model_from_pretrained=args.language_model_path,
        vision_model_from_pretrained=None,
        speech_model_from_pretrained=None,
        freeze_language_model=True,
        freeze_vision_model=True,
        freeze_vision_projection=False,
        freeze_speech_model=True,
        freeze_speech_projection=False,
    )

    model = vlm.AVLMModel(avlm_config, tokenizer=data.tokenizer)
