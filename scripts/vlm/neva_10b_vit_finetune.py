...
def main(args):
    ...
    if args.data_type == "llava":
        ...
        processor = AutoProcessor.from_pretrained("OpenGVLab/InternViT-300M-448px-V2_5", trust_remote_code=True)
        # Data configuration
    ...
    trainer = nl.Trainer(
        ...
        accelerator="gpu",
        strategy=strategy,
        plugins=nl.MegatronMixedPrecision(precision="bf16-mixed", grad_reduce_in_fp32=False,),
        callbacks=[
            checkpoint_callback,
            TimingCallback(),
