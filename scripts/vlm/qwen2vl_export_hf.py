...
def main():
    ...
    parser.add_argument(
        "--path",
        type=str,
        default="/root/.cache/nemo/models/Qwen/Qwen2-VL-2B-Instruct",
        help="Path to the NeMo checkpoint directory. (Default: /root/.cache/nemo/models/Qwen/Qwen2-VL-2B-Instruct)",
    )
    parser.add_argument(
        "--output_path",
        type=str,
