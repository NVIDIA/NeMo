...
def get_args(argv):
    ...
    parser.add_argument("-ol", "--output_logits", default=False, action='store_true', help="Returns logits")
    parser.add_argument("-os", "--output_scores", default=False, action='store_true', help="Returns scores")
