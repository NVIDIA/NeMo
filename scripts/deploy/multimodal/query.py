...
def get_args(argv):
    ...
    prompt_group.add_argument("-it", "--input_text", required=True, type=str, help="Input text")
    prompt_group.add_argument("-im", "--input_media", required=True, type=str, help="File path of input media")
