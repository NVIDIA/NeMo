...
def get_args():
    parser = argparse.ArgumentParser(description='Download HUI-Audio-Corpus-German and create manifests with predefined split')

    parser.add_argument("--data-root", required=True, type=Path)
    parser.add_argument("--speaker", default="Karlsson", choices=["Bernd_Ungerer", "Hokuspokus", "Friedrich", "Karlsson", "Eva_K"], type=str)
    ...
    parser.add_argument("--seed-for-ds-split", default=100, type=float, help="Seed for deterministic split of train/dev/test, NVIDIA's default is 100")
...
URL_STATS_CLEAN = "https://opendata.iisys.de/systemintegration/Datasets/HUI-Audio-Corpus-German/datasetStatisticClean.zip"
