...
from nemo.collections.llm.recipes.llama4_e128_256k import pretrain_recipe
...
if __name__ == "__main__":
    ...
    if args.use_thd_attention:
        kwargs = get_user_configs(args.gpu.lower(), "pre_train", "llama4", "e128_256k_thd", args)
    else:
        kwargs = get_user_configs(args.gpu.lower(), "pre_train", "llama4", "e128_256k", args)
