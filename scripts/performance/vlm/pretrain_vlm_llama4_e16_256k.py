...
from nemo.collections.vlm.recipes.llama4_omni_e16_256k import pretrain_recipe
...
def override_recipe_configs(
    ...
    recipe.model.config.language_transformer_config.num_moe_experts = 8
    return recipe
...
if __name__ == "__main__":
    ...
    kwargs = get_user_configs(args.gpu.lower(), "pre_train", "vlm_llama4", "e16_256k", args)
