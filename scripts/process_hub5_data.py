...
StmUtterance = namedtuple('StmUtterance', ['filename', 'channel', 'speaker_id', 'begin', 'end', 'label', 'transcript'])
...
def segment_audio(info_list, dest_root, min_slice_duration):
    ...
    for info in info_list:
        ...
        audio_buffer.append(audio_data[floor(info.begin * sample_rate) : ceil(info.end * sample_rate), channel])
