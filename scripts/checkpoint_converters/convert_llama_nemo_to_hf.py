...
def get_args():
    ...
    parser.add_argument(
        "--input-name-or-path", type=str, default=None, required=True, help="Path to .nemo file",
    )
    parser.add_argument("--output-path", type=str, default=None, required=True, help="Path to HF .bin file")
    parser.add_argument(
        "--hf-input-path",
        type=str,
        default=None,
