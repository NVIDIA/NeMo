...
def get_args():
    ...
    parser.add_argument("--sft-data-paths", type=str, default=None, help="SFT json file")
    ...
    parser.add_argument("--weight_decay", type=float, default=0.01, help="""value for weight decay""")
