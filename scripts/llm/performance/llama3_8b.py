...
from nemo.lightning.run.plugins import PerfEnvPlugin, NsysPlugin
...
if __name__ == "__main__":
    ...
    recipe = llama3_8b_performance(
        args.compute_dtype, num_nodes, num_gpus_per_node, mbs, gbs, tp_size, pp_size, cp_size, vp_size, max_steps,
        )
