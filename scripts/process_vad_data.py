...
def main():
    ...
    skip_num_val, seg_num_val, speech_val = load_list_write_manifest(speech_data_folder, out_dir, 'validation_list.txt', 'speech', 1, 1)
    skip_num_test, seg_num_test, speech_test = load_list_write_manifest(speech_data_folder, out_dir, 'testing_list.txt', 'speech', 1, 1)
    skip_num_train, seg_num_train, speech_train = load_list_write_manifest(speech_data_folder, out_dir, 'training_list.txt', 'speech', 1, 1)
    ...
    skip_num_val, seg_num_val, background_val = load_list_write_manifest(background_data_folder, out_dir, 'validation_list.txt', 'background', 1, 1)
    skip_num_test, seg_num_test, background_test = load_list_write_manifest(background_data_folder, out_dir, 'testing_list.txt', 'background', 1, 1)
    skip_num_train, seg_num_train, background_train = load_list_write_manifest(background_data_folder, out_dir, 'training_list.txt', 'background', 1, 1)
