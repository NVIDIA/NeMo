...
@hydra_runner(config_path="conf", config_name="adapter_ckpt_to_nemo")
def main(cfg) -> None:
    ...
    if cfg.checkpoint_dir:
        ...
        model: MegatronGPTAdapterLearningModel = MegatronGPTAdapterLearningModel.load_from_checkpoint(
