...
from nemo.collections.nlp.modules.common.megatron.retrieval_services.bm_25_retrieval_server import BM25RetrievalServer
...
@hydra_runner(config_path="conf", config_name="bm25_service")
def main(cfg) -> None:
    tokenizer = get_tokenizer(cfg.tokenizer)

    server = BM25RetrievalServer(
        cfg.service.filepath,
        cfg.service.sliding_window_length,
        cfg.service.sliding_length,
