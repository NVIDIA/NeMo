...
DEV_LIST = {'faks0', 'fdac1', 'fjem0', 'mgwt0', 'mjar0', 'mmdb1', 'mmdm2',
...
TEST_LIST = { 'mdab0', 'mwbt0', 'felc0', 'mtas1', 'mwew0', 'fpas0', 'mjmp0',
...
def __process_data(data_folder: str, dst_folder: str):
    ...
    for data_set in ['train', 'dev', 'test']:
        ...
        with open(dst_folder+"/"+data_set+".json", 'w') as fout:
            for m in entries:
