pipeline {
  agent {
      ...
      args '--device=/dev/nvidia0 --gpus all --user 0:128 -v /home/TestData:/home/TestData -v $HOME/.cache/torch:/root/.cache/torch -v $HOME/.cache/transformers:/root/.cache/transformers --shm-size=8g'
        }
  }
  options {
