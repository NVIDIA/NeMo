  ...
  stages {
    ...
    stage('L0: TN/ITN Tests CPU') {
      ...
      parallel {
        ...
        stage('En ITN grammars') {
          steps {
            sh 'CUDA_VISIBLE_DEVICES="" python nemo_text_processing/inverse_text_normalization/inverse_normalize.py --lang en "twenty" --cache_dir /home/TestData/nlp/text_norm/ci/grammars/2-3'
          }
        }
    ...
    stage('L2: NeMo text processing') {
      ...
      parallel {
        stage('L2: Eng TN') {
          steps {
            sh 'cd tools/text_processing_deployment && python pynini_export.py --output=/home/TestData/nlp/text_norm/output/ --grammars=tn_grammars --cache_dir /home/TestData/nlp/text_norm/ci/grammars/2-3 --lang=en && ls -R /home/TestData/nlp/text_norm/output/ && echo ".far files created "|| exit 1'
        ...
        stage('L2: Eng ITN export') {
          steps {
            sh 'cd tools/text_processing_deployment && python pynini_export.py --output=/home/TestData/nlp/text_denorm/output/ --grammars=itn_grammars --cache_dir /home/TestData/nlp/text_norm/ci/grammars/2-3 --lang=en && ls -R /home/TestData/nlp/text_denorm/output/ && echo ".far files created "|| exit 1'
