      ...
      parallel {
        stage('L2: TN') {
          steps {
            ...
            sh 'cd nemo_text_processing/text_normalization/ &&  python run_predict.py --input=/home/TestData/nlp/text_norm/ci/test.txt --input_case="cased" --output=/home/TestData/nlp/text_norm/output/test.pynini.txt --verbose'
