    ...
    stage('L2: NeMo text processing') {
      ...
      parallel {
        stage('L2: pynini export') {
          steps {
            sh 'cd tools/inverse_text_normalization && python pynini_export.py /home/TestData/nlp/text_denorm/output/ && ls -R /home/TestData/nlp/text_denorm/output/ && echo ".far files created "|| exit 1'
            sh 'cd tools/inverse_text_normalization && cp *.grm /home/TestData/nlp/text_denorm/output/'
