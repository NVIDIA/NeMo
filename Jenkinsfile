pipeline {
  agent {
        docker {
            ...
            args '--device=/dev/nvidia0 --gpus all --user 0:128 -v /home:/home -v /home/mrjenkins/.cache/torch/transformers:/root/.cache/torch/transformers --shm-size=8g'
        }
  }
  options {
