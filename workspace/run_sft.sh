...
TRAIN_MANIFESTS=[/gpfs/fs1/projects/ent_aiapps/users/zhehuaic/works/mod_speech_llm/data/sft_text/kickass-snake/kickass-snake_commercial.shuf.jsonl.1000]
TRAIN_MANIFESTS=[/media/data/datasets/LibriSpeech/dev_clean_10.json]
...
run_sft_audio_lm.py --config-path="../examples/multimodel/conf/speechllm/" --config-name "modularized_speech_gpt_config" \
    ...
    model.perception.target=nemo.collections.multimodal.speechllm.modules.speechllm_perception.CtcAudioPerceptionModel \
